...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <mergerTreeBuildMasses name="mergerTreeBuildMassesReadHDF5">
   <description>
    ...
    \end{verbatim}
    where the \source{treeRootMass} dataset contains the mass (in Solar masses) of the root halo of a tree to
    generate, and the (optional) \source{treeWeight} dataset contains the weight (in units of Mpc$^{-3}$) to
    assign to each tree.
   </description>
