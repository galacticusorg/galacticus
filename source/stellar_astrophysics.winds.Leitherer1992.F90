...
contains
  ...
  double precision function leitherer1992RateMassLoss(self,initialMass,age,metallicity)
    !!{
    Compute the mass loss rate (in $M_\odot$/Gyr) from a star of given \source{initialMass}, {\normalfont
    \ttfamily age} and \source{metallicity} using the fitting formula of \cite{leitherer_deposition_1992}.
    !!}
    implicit none
  ...
  double precision function leitherer1992VelocityTerminal(self,initialMass,age,metallicity)
    !!{
    Compute the terminal velocity (in km/s) from a star of given \source{initialMass}, \source{age} and \source{metallicity} using
