...
module Accretion_Halo_Totals
  ...
  <functionClass>
   ...
   <method name="accretionRate" >
    <description>Return the total accretion rate onto the given \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
   <method name="accretedMass" >
    <description>Return the total accreted mass in the given \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
