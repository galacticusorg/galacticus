...
contains
  ...
  subroutine conditionalMassFunctionPerform(self,status)
    ...
    call outputGroup%writeDataset(self%massBinCenters,"mass" ,description="mass in units of M☉")
    if (self%integrateOverHaloMassFunction) then
       call outputGroup%writeDataset(conditionalMassFunction          ,"massFunction"          ,description="Mass function in units of Mpc⁻³ per log(mass)."                 )
       call outputGroup%writeDataset(conditionalMassFunctionIncomplete,"massFunctionIncomplete",description="Incomplete mass function in units of Mpc⁻³ per log(mass)."      )
    else
       call outputGroup%writeDataset(conditionalMassFunction          ,"massFunction"          ,description="Conditional mass function in units of per log(mass)."           )
       call outputGroup%writeDataset(conditionalMassFunctionIncomplete,"massFunctionIncomplete",description="Incomplete conditional mass function in units of per log(mass).")
    end if
