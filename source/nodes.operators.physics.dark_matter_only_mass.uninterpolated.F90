...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface nodeOperatorDMOUninterpolated
     !!{RST
     Constructors for the :galacticus-class:`nodeOperatorDMOUninterpolated` node operator class.
     !!}
...
contains
  ...
  function dmoUninterpolatedConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the :galacticus-class:`nodeOperatorDMOUninterpolated` node operator class which takes a parameter set as input.
    !!}
