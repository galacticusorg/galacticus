...
program Tests_Spherical_Collapse_Baryons_Dark_Matter
  ...
  use Spherical_Collapse_Matter_Dark_Energy, only : darkEnergySphericalCollapseEnergyFixedAtTurnaround
  use Linear_Growth                        , only : linearGrowthBaryonsDarkMatter                     , linearGrowthSimple                             , componentDarkMatter
  ...
  use Cosmological_Density_Field           , only : criticalOverdensitySphericalCollapseMatterLambda  , criticalOverdensitySphericalCollapseBaryonsDM  , cosmologicalMassVarianceFilteredPower
  use Virial_Density_Contrast              , only : virialDensityContrastSphericalCollapseMatterLambda, virialDensityContrastSphericalCollapseBaryonsDM
  ...
  type            (criticalOverdensitySphericalCollapseBaryonsDM     )                          :: criticalOverdensitySphericalCollapseBaryonsDM_
  type            (virialDensityContrastSphericalCollapseMatterLambda)                          :: virialDensityContrastSphericalCollapseMatterLambda_
  type            (virialDensityContrastSphericalCollapseBaryonsDM   )                          :: virialDensityContrastSphericalCollapseBaryonsDM_
  ...
  do j=1,countFractionBaryon
     ...
     criticalOverdensitySphericalCollapseMatterLambda_  =criticalOverdensitySphericalCollapseMatterLambda  (                                                                                        &
          ...
          &                                                                                                 tableStore                         =.true.                                              &
          &                                                                                                )
     criticalOverdensitySphericalCollapseBaryonsDM_     =criticalOverdensitySphericalCollapseBaryonsDM     (                                                                                        &
          ...
          &                                                                                                 normalization                      =1.0d0                                               &
          &                                                                                                )
     virialDensityContrastSphericalCollapseMatterLambda_=virialDensityContrastSphericalCollapseMatterLambda(                                                                                        &
          &                                                                                                 tableStore                         =.false.                                           , &
          &                                                                                                 cosmologyFunctions_                =cosmologyFunctionsMatterLambda_                     &
          &                                                                                                )

     virialDensityContrastSphericalCollapseBaryonsDM_   =virialDensityContrastSphericalCollapseBaryonsDM   (                                                                                        &
          &                                                                                                 tableStore                         =.true.                                            , &
          &                                                                                                 energyFixedAt                      =darkEnergySphericalCollapseEnergyFixedAtTurnaround, &
          &                                                                                                 cosmologyParameters_               =cosmologyParametersDMO_                           , &
          &                                                                                                 cosmologyFunctions_                =cosmologyFunctionsMatterLambda_                   , &
          &                                                                                                 intergalacticMediumFilteringMass_  =intergalacticMediumFilteringMassGnedin2000_         &
          &                                                                                                )
     ...
     do i=1,size(redshift)
        ...
        criticalOverdensityDMO      =criticalOverdensitySphericalCollapseMatterLambda_  %value                      (time=time              ,mass=1.0d8)
        criticalOverdensityBaryons  =criticalOverdensitySphericalCollapseBaryonsDM_     %value                      (time=time              ,mass=1.0d8)
        virialDensityContrastDMO    =virialDensityContrastSphericalCollapseMatterLambda_%densityContrast            (time=time              ,mass=1.0d8)
        virialDensityContrastBaryons=virialDensityContrastSphericalCollapseBaryonsDM_   %densityContrast            (time=time              ,mass=1.0d8)
        radiusTurnaroundDMO         =virialDensityContrastSphericalCollapseMatterLambda_%turnAroundOverVirialRadii  (time=time              ,mass=1.0d8)
        radiusTurnaroundBaryons     =virialDensityContrastSphericalCollapseBaryonsDM_   %turnAroundOverVirialRadii  (time=time              ,mass=1.0d8)
