...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <blackHoleWind name="blackHoleWindCiotti2009">
   <description>
     ...
     \end{equation}
     where $\dot{M}_\bullet$ is the black hole accretion rate, $\epsilon_\mathrm{w}=$\source{[efficiencyWind]} is
     an overall efficiency parameter, $\epsilon_\mathrm{r}$ is the radiative efficiency of the accretion flow \emph{if}
     \source{[efficiencyWindScalesWithEfficiencyRadiative]=true}, and $1$ otherwise, and $f_\mathrm{w}$ represents
