...
module Numerical_Constants_Math
  ...
  <constant variable="Pi" gslSymbol="M_PI" gslHeader="gsl_math" symbol="\pi" units="dimensionless" unitsInSI="1.0" description="The ratio of a circle's perimter to its diameter." externalDescription="https://en.wikipedia.org/wiki/Pi" reference="Gnu Scientific Library" referenceURL="https://www.gnu.org/software/gsl/doc/html/math.html#mathematical-constants" group="math"/>
  <constant variable="PiQuadPrecision" value="3.141592653589793238462643383279502884197_kind_quad" type="real(kind_quad)" symbol="\pi" units="dimensionless" unitsInSI="1.0" description="The ratio of a circle's perimter to its diameter (to quadruple precision)." externalDescription="https://en.wikipedia.org/wiki/Pi" reference="OEIS: A002117" referenceURL="https://oeis.org/A002117"  group="math"/>
