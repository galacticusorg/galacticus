...
program Test_Zhao2009_Flat
  ...
  double precision,    parameter, dimension(1) :: timeDifferenceTolerance         =[3.4d-2], &
       &                                          concentrationDifferenceTolerance=[3.3d-2]
  ...
  do iMass=1,size(logarithmicHaloMasses)
     ...
     fileName='testSuite/data/zhao2009MassAccretionHistories/mandcoutputEdSlgM'
