...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  type, extends(mergerTreeOutputterClass) :: mergerTreeOutputterStandard
   ...
   contains
     !![
     <methods>
       <method description="Make an group in the \glc\ file in which to store \source{tree}." method="makeGroup"             />
...
contains
  ...
  subroutine standardMakeGroup(self,tree,indexOutput)
    !!{
    Make an group in the \glc\ file in which to store \source{tree}.
    !!}
