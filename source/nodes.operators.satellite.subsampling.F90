...
contains
  ...
  function satelliteSubsamplingConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      ...
      <defaultValue>0.0d0</defaultValue>
      <description>Pericenter distance threshold above which satellites are subsampled in units of the distance to the host halo at infall. This criterion will be ignored if the \source{virialOrbit} of satellite is not gettable.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
