...
contains
  ...
  subroutine Merger_Trees_Millennium_Process(nodesFile,particlesFile,mergerTrees,generation)
    ...
    call                     mergerTrees%setPropertyColumn(propertyTypeNodeMass200Mean         , 8)
    call                     mergerTrees%setPropertyColumn(propertyTypeNodeMass200Crit         , 9)
    call                     mergerTrees%setPropertyColumn(propertyTypeParticleCount           ,10)
    call                     mergerTrees%setPropertyColumn(propertyTypePositionX               ,11)
    call                     mergerTrees%setPropertyColumn(propertyTypePositionY               ,12)
    call                     mergerTrees%setPropertyColumn(propertyTypePositionZ               ,13)
    call                     mergerTrees%setPropertyColumn(propertyTypeVelocityX               ,14)
    call                     mergerTrees%setPropertyColumn(propertyTypeVelocityY               ,15)
    call                     mergerTrees%setPropertyColumn(propertyTypeVelocityZ               ,16)
    call                     mergerTrees%setPropertyColumn(propertyTypeSpecificAngularMomentumX,17)
    call                     mergerTrees%setPropertyColumn(propertyTypeSpecificAngularMomentumY,18)
    call                     mergerTrees%setPropertyColumn(propertyTypeSpecificAngularMomentumZ,19)
    call                     mergerTrees%setPropertyColumn(propertyTypeHalfMassRadius          ,20)
    if (traceParticles) call mergerTrees%setPropertyColumn(propertyTypeMostBoundParticleIndex  ,21)
    call                     mergerTrees%setPropertyColumn(propertyTypeVelocityMaximum         ,22)
    call                     mergerTrees%setPropertyColumn(propertyTypeVelocityDispersion      ,23)
