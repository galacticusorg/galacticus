...
module Star_Formation_Rate_Surface_Density_Disks_KMT09
  ...
  ! Precomputed factors.
  double precision                              :: hydrogenMassFraction,gasMass,diskScaleRadius,metallicityRelativeToSolar &
       & ,chi,sigmaMolecularComplexNormalization,sNormalization
...
contains
  ...
  double precision function Star_Formation_Rate_Surface_Density_Disk_KMT09(thisNode,radius)
    ...
    double precision                                            :: surfaceDensityGas,molecularFraction ,cloudFactor&
         &,surfaceDensityGasDimensionless ,sigmaMolecularComplex,s
