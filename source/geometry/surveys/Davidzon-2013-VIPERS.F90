...
!!{RST
Implements the geometry of the VIPERS survey used by :cite:t:`davidzon_vimos_2013`.
!!}

  use :: Cosmology_Functions, only : cosmologyFunctionsClass

  !![
  <surveyGeometry name="surveyGeometryDavidzon2013VIPERS" docformat="rst">
   <description>
   A survey geometry class that describes the survey geometry of :cite:t:`davidzon_vimos_2013`.
  ...
  interface surveyGeometryDavidzon2013VIPERS
     !!{RST
     Constructors for the :cite:t:`davidzon_vimos_2013` survey geometry class.
     !!}
...
contains
  ...
  function davidzon2013VIPERSConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the :cite:t:`davidzon_vimos_2013` conditional mass function class which takes a parameter set as input.
    !!}
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The redshift bin (0, 1, 2) of the :cite:t:`davidzon_vimos_2013` mass function to use.
      </description>
    </inputParameter>
    !!]
    self=surveyGeometryDavidzon2013VIPERS(redshiftBin,cosmologyFunctions_,randomNumberGenerator_)
    !![
  ...
  function davidzon2013VIPERSConstructorInternal(redshiftBin,cosmologyFunctions_,randomNumberGenerator_) result(self)
    !!{RST
    Internal constructor for the :cite:t:`davidzon_vimos_2013` mass function class.
    !!}
    use :: Cosmology_Functions        , only : cosmologyFunctionsClass
  ...
  integer function davidzon2013VIPERSAngularPowerMaximumDegree(self)
    !!{RST
    Return the maximum degree for which angular power is computed for the :cite:t:`davidzon_vimos_2013` survey.
    !!}
    implicit none
    class(surveyGeometryDavidzon2013VIPERS), intent(inout) :: self
    !$GLC attributes unused :: self
