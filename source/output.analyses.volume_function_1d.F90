...
!!}
  ...
  <outputAnalysis name="outputAnalysisVolumeFunction1D">
   <description>
     ...
     \ttfamily [covarianceModel]}. If set to \source{binomial}, then to construct $\mathbf{C}_\mathrm{model}$ we
     ...
     determined by the parameters \source{[covarianceBinomialMassHaloMinimum]}, {\normalfont \ttfamily
     [covarianceBinomialMassHaloMaximum]}, and \source{[covarianceBinomialBinsPerDecade]}.
  
     If instead, \source{[covarianceModel]}$=$\source{Poisson}, the main branch galaxies are
