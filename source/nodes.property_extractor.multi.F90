  ...
  type, extends(nodePropertyExtractorClass) :: nodePropertyExtractorMulti
   ...
   contains
     ...
     <methods>
       ...
       <method description="Extract the double properties from the given \source{node}."  method="extractDouble"     />
       <method description="Extract the integer properties from the given \source{node}." method="extractInteger"    />
