  ...
  type, public :: vector
   ...
   contains
     ...
     <methods>
       ...
       <method description="Compute \source{vector1} $\cdot$ \source{vector2}."  method="operator(.dot.)"  />
       <method description="Compute \source{vector1}-\source{vector2}."          method="operator(-)"      />
       <method description="Compute \source{vector1}+\source{vector2}."          method="operator(+)"      />
       <method description="Compute \source{vector1} $\times$ \source{vector2}." method="operator(.cross.)"/>
...
contains
  ...
  function vectorConstructor(array) result(self)
    !!{
    Constructor for \source{vector} class which builds the vector from an array.
    !!}
    implicit none
    type            (vector  )                              :: self
  ...
  function vectorZeroConstructor(n) result(self)
    !!{
    Constructor for \source{vector} class which builds the vector and initializes all elements to zero.
    !!}
    implicit none
    type   (vector  )                :: self
  ...
  function vectorCopyConstructor(source) result(self)
    !!{
    Constructor for the \source{vector} class which builds the vector by copying a \source{source} vector.
    !!}
  ...
  subroutine vectorAssignmentConstructor(self,array)
    !!{
    Constructor for \source{vector} class which overloads the assignment operator.
    !!}
    implicit none
  ...
  subroutine vectorUnassignment(array,self)
    !!{
    Assign elements of a \source{vector} class to an array
    !!}
    implicit none
  ...
  subroutine vectorDestructorRank0(self)
    !!{
    Rank-0 destructor for the \source{vector} class.
    !!}
    implicit none
  ...
  subroutine vectorDestructorRank1(self)
    !!{
    Rank-1 destructor for the \source{vector} class.
    !!}
    implicit none
  ...
  function matrixConstructor(array) result(self)
    !!{
    Constructor for \source{matrix} class which builds the matrix from an array.
    !!}
    implicit none
    type            (matrix  )                                :: self
    double precision          , intent(in   ), dimension(:,:) :: array
  ...
  function matrixZeroConstructor(n1,n2) result(self)
    !!{
    Constructor for \source{matrix} class which builds the matrix and initializes all elements to zero.
    !!}
    implicit none
    type   (matrix  )                :: self
  ...
  function matrixCopyConstructor(source) result(self)
    !!{
    Constructor for the \source{matrix} class which builds the matrix by copying a \source{source} matrix.
    !!}
    use :: Error        , only : Error_Report
    use :: Interface_GSL, only : GSL_Success
    implicit none
  ...
  subroutine matrixAssignmentConstructor(self,array)
    !!{
    Constructor for \source{matrix} class which overloads the assignment operator.
    !!}
    implicit none
  ...
  subroutine matrixUnassignment(array,self)
    !!{
    Assign elements of a \source{matrix} class to an array
    !!}
    implicit none
    double precision          , intent(  out), dimension(:,:) :: array
  ...
  subroutine matrixDestructorRank0(self)
    !!{
    Destructor for the \source{matrix} class
    !!}
    implicit none
  ...
  function matrixLUConstructor(matrix_) result(self)
    !!{
    Constructor for \source{matrixLU} class which builds the matrix from an array.
    !!}
    use :: Error        , only : Error_Report
    use :: Interface_GSL, only : GSL_Success
    implicit none
  ...
  subroutine matrixLUDestructorRank0(self)
    !!{
    Destructor for the \source{matrixLU} class
    !!}
    implicit none
  ...
  subroutine matrixLUUnassignment(array,self)
    !!{
    Assign elements of a \source{matrixLU} class to an array
    !!}
    implicit none
    double precision          , intent(  out), dimension(:,:) :: array
