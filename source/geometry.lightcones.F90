...
module Geometry_Lightcones
  ...
  <functionClass>
   ...
   <method name="position" >
    <description>Returns the position vector of a \source{node} (in units of Mpc) in the lightcone coordinate system.</description>
   ...
   <method name="velocity" >
    <description>Returns the velocity vector of a \source{node} (in units of km/s) in the lightcone coordinate system.</description>
    <type>double precision, dimension(3)</type>
    <pass>yes</pass>
    <argument>type   (treeNode), intent(inout) :: node</argument>
    <argument>integer(c_size_t), intent(in   ) :: instance</argument>
   ...
   <method name="timeLightconeCrossing" >
    <description>Returns the next time in the interval from the current node time to \source{timeEnd} at which any replicant of this node will cross the lightcone. If no crossing occurs during this interval a very large value is returned instead.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type            (treeNode), intent(inout)                                      :: node                  </argument>
   ...
   <method name="positionLightconeCrossing" >
    <description>Returns the position of the node at the time of lightcone crossing---which must have been previously identified via the \source{timeLightconeCrossing} method.</description>
    <type>double precision, dimension(3)</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
   <method name="velocityLightconeCrossing" >
    <description>Returns the velocity of the node at the time of lightcone crossing---which must have been previously identified via the \source{timeLightconeCrossing} method.</description>
    <type>double precision, dimension(3)</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
