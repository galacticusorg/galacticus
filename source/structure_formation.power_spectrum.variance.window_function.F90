...
module Power_Spectrum_Window_Functions
  ...
  <functionClass>
   ...
   <method name="value" >
    <description> Returns the window function for power spectrum variance computation at the specified \source{wavenumber} (in Mpc$^{-1}$) for a given \source{smoothingMass} (in $M_\odot$).</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: wavenumber, smoothingMass</argument>
   </method>
   <method name="wavenumberMaximum" >
    <description>Returns the maximum wavenumber for which the window function for power spectrum variance computation is non-zero for a given \source{smoothingMass} (in $M_\odot$).</description>
    <type>double precision</type>
    <pass>yes</pass>
