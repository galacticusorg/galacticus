...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <mergerTreeOperator name="mergerTreeOperatorPruneLightcone">
   <description>
    ...
    completely pruned away. If the parameter \mono{[splitTrees]} is set to \mono{true} then
    ...
    forest). If the parameter \mono{[bufferIsolatedHalos]} is set to \mono{true} then, when
