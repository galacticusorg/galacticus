...
module Stellar_Astrophysics_Winds
  ...
  <functionClass>
   ...
   <method name="rateMassLoss" >
    <description>Return the mass loss rate (in $M_\odot$/Gyr) from stars of given \source{initialMass}, \source{age} and \source{metallicity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: initialMass, age, metallicity</argument>
   </method>
   <method name="velocityTerminal" >
    <description>Return the terminal velocity (in km/s) of winds from stars of given \source{initialMass}, \source{age} and \source{metallicity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: initialMass, age, metallicity</argument>
   </method>
