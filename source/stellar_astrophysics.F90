...
module Stellar_Astrophysics
  ...
  <functionClass>
   ...
   <method name="massInitial" >
    <description>Returns the initial mass of a star of given \source{lifetime} and \source{metallicity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: lifetime, metallicity</argument>
   </method>
   <method name="massEjected" >
    <description>Returns the mass ejected by a star of given \source{massInitial} and \source{metallicity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: massInitial,metallicity</argument>
   </method>
   <method name="massYield" >
    <description>Returns the metal mass yielded by a star of given \source{massInitial} and \source{metallicity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   )           :: massInitial, metallicity</argument>
   ...
   <method name="lifetime" >
    <description>Returns the lifetime of a star of given \source{massInitial} and \source{metallicity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: massInitial, metallicity</argument>
   </method>
