...
module Stellar_Astrophysics
  ...
  <functionClass docformat="rst">
   ...
   <description>
   Class providing individual stellar astrophysics---the properties of single stars as a function of initial mass and metallicity, including the stellar lifetime, the mass ejected (returned to the :term:`ISM`) at death, and the metal mass yielded. These per-star quantities are integrated over the :term:`IMF` and star formation history to compute the net recycling, yield, and energy input for a stellar population. Implementations are typically based on stellar evolution grids from e.g. :cite:t:`portinari_galactic_1998` or similar libraries and include inverse functions mapping lifetime to initial mass.
   </description>
   <default>file</default>
   <method name="massInitial" >
    <description>
    Returns the initial mass of a star of given ``lifetime`` and ``metallicity``.
    </description>
   ...
   <method name="massEjected" >
    <description>
    Returns the mass ejected by a star of given ``massInitial`` and ``metallicity``.
    </description>
    <type>double precision</type>
    <pass>yes</pass>
   ...
   <method name="massYield" >
    <description>
    Returns the metal mass yielded by a star of given ``massInitial`` and ``metallicity``.
    </description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   )           :: massInitial, metallicity</argument>
   ...
   <method name="lifetime" >
    <description>
    Returns the lifetime of a star of given ``massInitial`` and ``metallicity``.
    </description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: massInitial, metallicity</argument>
