...
!!{RST
Implements a stellar mass function output analysis class for the PRIMUS survey of :cite:t:`moustakas_primus:_2013`.
!!}


  !![
  <outputAnalysis name="outputAnalysisMassFunctionStellarPRIMUS" docformat="rst">
   <description>
   A PRIMUS stellar mass function output analysis class, for :math:`z\approx 0.2` to :math:`z\approx 1` galaxies measured by :cite:t:`moustakas_primus:_2013`.
  ...
  end interface outputAnalysisMassFunctionStellarPRIMUS
...
contains
  ...
  function massFunctionStellarPRIMUSConstructorParameters(parameters) result (self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The redshift interval (0-5) to use.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      ...
      <description>
      The minimum random error for PRIMUS stellar masses.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
    ...
    <inputParameter docformat="rst">
      ...
      <defaultValue>[0.1d0]</defaultValue>
      <description>
      The coefficients of the random error polynomial for PRIMUS stellar masses.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      ...
      <description>
      The coefficients of the systematic error polynomial for PRIMUS stellar masses.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The number of bins per decade of halo mass to use when constructing PRIMUS stellar mass function covariance matrices for main branch galaxies.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      ...
      <description>
      The minimum halo mass to consider when constructing PRIMUS stellar mass function covariance matrices for main branch galaxies.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      ...
      <description>
      The maximum halo mass to consider when constructing PRIMUS stellar mass function covariance matrices for main branch galaxies.
      </description>
    </inputParameter>
  ...
  function massFunctionStellarPRIMUSConstructorInternal(cosmologyFunctions_,gravitationalLensing_,outputTimes_,redshiftInterval,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing) result (self)
    ...
    use :: Geometry_Surveys                      , only : surveyGeometryMoustakas2013PRIMUS
    ...
    type            (surveyGeometryMoustakas2013PRIMUS                  )               , pointer      :: surveyGeometry_
    ...
    !!]
    ! Build the PRIMUS survey geometry of Moustakas et al. (2013) with their imposed redshift limits.
    allocate(surveyGeometry_)
    !![
    <referenceConstruct object="surveyGeometry_" constructor="surveyGeometryMoustakas2013PRIMUS(redshiftBin=redshiftInterval,cosmologyFunctions_=cosmologyFunctions_)"/>
    !!]
