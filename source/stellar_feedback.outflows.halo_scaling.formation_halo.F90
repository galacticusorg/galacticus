...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  !![
  <stellarFeedbackOutflows name="stellarFeedbackOutflowsHaloScalingFormationHalo" docformat="rst">
   <description>
...
contains
  ...
  function haloScalingFormationHaloConstructorParameters(parameters) result(self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The normalization :math:`f` of the outflow rate relative to the star formation rate, evaluated at the formation halo's virial velocity of 200 km/s and expansion factor of 1, setting the overall mass-loading amplitude.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The power-law exponent of the cosmological expansion factor :math:`(1+z)` in the formation-halo outflow rate, allowing the mass-loading factor to evolve with the redshift of the formation halo; a value of zero gives no redshift evolution.
      </description>
    </inputParameter>
