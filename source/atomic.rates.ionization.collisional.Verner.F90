...
!% Contains a module which computes rates of atomic direct collisional ionization using the fitting function of
...
module Atomic_Rates_Ionization_Collisional_Verner
...
contains
  ...
  !# </atomicCollisionalIonizationMethod>
  subroutine Atomic_Rate_Ionization_Collisional_Verner_Initialize(atomicCollisionalIonizationMethod,Atomic_Rate_Ionization_Collisional_Get)
  ...
  double precision function Atomic_Rate_Ionization_Collisional_Verner(atomicNumber,ionizationState,temperature)
    ...
    double precision             :: temperatureScaled,energyScaled
    ...
    temperatureScaled=temperature*boltzmannsConstant/electronVolt
    energyScaled=fitCoefficient(1,atomicNumber,electronNumber)/temperatureScaled
...
end module Atomic_Rates_Ionization_Collisional_Verner
