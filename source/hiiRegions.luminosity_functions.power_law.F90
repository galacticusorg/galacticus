...
!+    Contributions to this file made by: Sachi Weerasooriya
  ...
  <hiiRegionLuminosityFunction name="hiiRegionLuminosityFunctionPowerLaw">
   <description>
    ...
    [rateHydrogenIonizingPhotonsMinimum]} and $Q_\mathrm{H,max}=$\source{[rateHydrogenIonizingPhotonsMaximum]} and
    the minimum and maximum HII region luminosities respectively, and $\alpha=$\source{[exponent]}.
   </description>
