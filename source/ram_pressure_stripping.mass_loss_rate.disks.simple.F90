...
contains
  ...
  subroutine Ram_Pressure_Stripping_Mass_Loss_Rate_Disks_Simple_Init(ramPressureStrippingMassLossRateDisksMethod,Ram_Pressure_Stripping_Mass_Loss_Rate_Disk_Get)
    ...
    procedure(Ram_Pressure_Stripping_Mass_Loss_Rate_Disk_Simple), pointer, intent(inout) :: Ram_Pressure_Stripping_Mass_Loss_Rate_Disk_Get
  ...
  double precision function Ram_Pressure_Stripping_Mass_Loss_Rate_Disk_Simple(thisNode)
    ...
    double precision                                            :: forceRamPressure,radiusHalfMass,surfaceDensityGas&
         &,surfaceDensityTotal,massLossRateFractional,forceGravitational,timeDynamical
