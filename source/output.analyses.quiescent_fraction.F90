...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface outputAnalysisQuiescentFraction
     !!{
     Constructors for the ``quiescentFraction'' output analysis class.
     !!}
     module procedure quiescentFractionConstructorParameters
     module procedure quiescentFractionConstructorFile
     module procedure quiescentFractionConstructorInternal
  end interface outputAnalysisQuiescentFraction
...
contains
  ...
  function quiescentFractionConstructorInternal(label,comment,massesStellar,starFormationRateSpecificQuiescentLogarithmic,starFormationRateSpecificLogarithmicError,galacticFilter_,surveyGeometry_,cosmologyFunctions_,cosmologyFunctionsData,outputTimes_,outputAnalysisPropertyOperator_,outputAnalysisDistributionOperator_,outputAnalysisWeightPropertyOperator_,starFormationRateDisks_,starFormationRateSpheroids_,starFormationRateNuclearStarClusters_,targetLabel,meanValueTarget,meanCovarianceTarget) result(self)
    ...
    type            (outputAnalysisPropertyOperatorNormal           )               , pointer                       :: outputAnalysisPropertyOperatorNormal_
    ...
    ! Build "normal" property operator to convert from specific star formation rate to quiescent fraction.
    allocate(outputAnalysisPropertyOperatorNormal_)
    !![
    <referenceConstruct object="outputAnalysisPropertyOperatorNormal_">
      <constructor>
	outputAnalysisPropertyOperatorNormal(                                                             &amp;
	   &amp;                             rangeLower  =-huge(0.0d0)                                  , &amp;
	   &amp;                             rangeUpper  =+starFormationRateSpecificQuiescentLogarithmic, &amp;
	   &amp;                             rootVariance=+starFormationRateSpecificLogarithmicError    , &amp;
	   &amp;                             extentLower =-huge(0.0d0)                                  , &amp;
	   &amp;                             extentUpper =+huge(0.0d0)                                    &amp;
	   &amp;                            )
      </constructor>
    </referenceConstruct>
    !!]    
    ...
    type is (outputAnalysisPropertyOperatorSequence)
       ...
       call outputAnalysisWeightPropertyOperator_%apppend(outputAnalysisPropertyOperatorNormal_)
    ...
    class default
       ...
       allocate(weightPropertyOperatorSequence%next%next)
       ...
       weightPropertyOperatorSequence%next%next%operator_ => outputAnalysisPropertyOperatorNormal_
    ...
    <objectDestructor name="outputAnalysisPropertyOperatorNormal_"           />   
    !!]
    nullify(propertyOperatorSequence)
    return
  end function quiescentFractionConstructorInternal
