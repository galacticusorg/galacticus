...
contains
  ...
  function gaussianSphereConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      <name>position</name>
      <description>The initial position for the sphere. If this is set to \source{priorMedian}, then the sphere is placed at the median of the prior in each dimension. Otherwise, this must be a list of starting parameter values.</description>
      <source>parameters</source>
