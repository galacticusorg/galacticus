...
module Dark_Matter_Profiles_Concentration
  ...
  <functionClass>
   ...
   <method name="concentration" >
    <description>Returns the concentration parameter for the given \source{node}.</description>
   ...
   <method name="concentrationMean" >
    <description>Returns the mean concentration parameter for a \source{node} of the given mass.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout), target :: node</argument>
   ...
   <method name="densityContrastDefinition" >
    <description>Returns a \source{virialDensityContrast} object describing the virial density contrast used to define this concentration.</description>
    <type>class(virialDensityContrastClass)</type>
    <pass>yes</pass>
   </method>
   <method name="darkMatterProfileDMODefinition" >
    <description>Returns a \source{darkMatterProfileDMO} object describing the dark matter density profile used to define this concentration.</description>
