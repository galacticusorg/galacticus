...
contains
  ...
  function heatedConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{heated} dark matter halo profile class.
    !!}
    ...
    <inputParameter>
      ...
      <defaultValue>.false.</defaultValue>
      <source>parameters</source>
      <description>If \source{true}, tolerate failures to compute the velocity dispersion.</description>
    </inputParameter>
    <inputParameter>
