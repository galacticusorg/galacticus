...
contains
  ...
  function ludlow2016AnalyticConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{ludlow2016Analytic} dark matter halo profile scale radius class.
    !!}
  ...
  double precision function ludlow2016AnalyticFormationTimeRoot(timeFormation) result(formationTimeRoot)
    !!{
    Function used to find the formation time of a halo in the \source{ludlow2016Analytic} scale radius algorithm.
    !!}
