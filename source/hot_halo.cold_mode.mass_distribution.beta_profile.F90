...
contains
  ...
  function betaProfileConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the ``hotHaloColdModeMassDistributionBetaProfile`` hot halo cold mode mass distribution class which takes a parameter set as input.
    !!}
  ...
  function betaProfileConstructorInternal(beta,hotHaloColdModeCoreRadii_) result(self)
    !!{RST
    Internal constructor for the ``hotHaloColdModeMassDistributionBetaProfile`` hot halo cold mode mass distribution class.
    !!}
    implicit none
    type            (hotHaloColdModeMassDistributionBetaProfile)                        :: self
  ...
  subroutine betaProfileDestructor(self)
    !!{RST
    Destructor for the ``hotHaloColdModeMassDistributionBetaProfile`` hot halo cold mode mass distribution class.
    !!}
    implicit none
