...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <mergerRemnantSize name="mergerRemnantSizeCole2000" docformat="rst">
   ...
   .. [#] Depending on the merging rules (see :galacticus-class:`mergerMassMovements`) not all mass may be placed into the spheroid :term:`component` of the remnant.
   .. [#] In practice, Galacticus computes a weighted average of the disk and spheroid half-mass radii of each galaxy, with weights equal to the masses of each :term:`component` (disk and spheroid) which will become part of the spheroid :term:`component` of the remnant.
   </description>
  </mergerRemnantSize>
  !!]
