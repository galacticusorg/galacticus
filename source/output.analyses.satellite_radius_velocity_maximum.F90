...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface outputAnalysisSatelliteRadiusVelocityMaximum
     !!{
     Constructors for the ``satelliteRadiusVelocityMaximum'' output analysis class.
     !!}
...
contains
  ...
  function satelliteRadiusVelocityMaximumConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``satelliteRadiusVelocityMaximum'' output analysis class which takes a parameter set as input.
    !!}
