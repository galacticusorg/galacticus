...
contains
  ...
  subroutine haloMassFunctionPerform(self,status)
    ...
    do iOutput=1,outputCount
       ...
       call dataset%writeAttribute(unitsMake(unitsInSI=1.0d0/megaParsec**3/massSolar),'units')
       ...
       call dataset%writeAttribute(unitsMake(unitsInSI=kilo),'units')
       ...
       call dataset%writeAttribute(unitsMake(unitsInSI=megaParsec),'units')
       ...
       if (self%includeMassAccretionRate) then
          ...
          call dataset%writeAttribute(unitsMake(unitsInSI=massSolar/gigaYear),'units')
       end if
