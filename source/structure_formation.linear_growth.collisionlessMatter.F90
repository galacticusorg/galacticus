...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  type, extends(linearGrowthClass) :: linearGrowthSimple
   ...
   contains
     ...
     procedure :: logarithmicDerivativeWavenumber      => simpleLogarithmicDerivativeWavenumber
     procedure :: retabulate                           => simpleRetabulate
     procedure :: isWavenumberDependent                => simpleIsWavenumberDependent
...
contains
  ...
  double precision function simpleLogarithmicDerivativeWavenumber(self,time,expansionFactor,collapsing,component,wavenumber)
    ...
    simpleLogarithmicDerivativeWavenumber=0.0d0
    return
  end function simpleLogarithmicDerivativeWavenumber

  logical function simpleIsWavenumberDependent(self,component)
    ...
    simpleIsWavenumberDependent=.false.
    return
  end function simpleIsWavenumberDependent
