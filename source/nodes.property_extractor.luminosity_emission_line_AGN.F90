...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <nodePropertyExtractor name="nodePropertyExtractorLmnstyEmssnLineAGN">
    <description>
      ...
      (given by the \source{lineNames} parameter are computed, largely following the model of
...
contains
  ...
  integer function lmnstyEmssnLineAGNElementCount(self,time)
    !!{
    Return the number of elements in the \source{lmnstyEmssnLineAGN} property extractor.
    !!}
    implicit none
  ...
  !!{
    Return the units of the \source{lmnstyEmssnLineAGN} properties in the SI system.
    !!}
