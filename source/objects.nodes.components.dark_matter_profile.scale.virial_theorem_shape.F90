...
module Node_Component_Dark_Matter_Profile_VT_Shape
  ...
  use :: Galacticus_Nodes          , only : nodeComponentDarkMatterProfileVTShape, treeNode
  implicit none
  private
  public :: Node_Component_Dark_Matter_Profile_VT_Shape_Rate_Compute, Node_Component_Dark_Matter_Profile_VT_Shape_Tree_Initialize, &
       &    Node_Component_Dark_Matter_Profile_VT_Shape_Scale_Set   , Node_Component_Dark_Matter_Profile_VT_Shape_Initialize     , &
       &    Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Init , Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Uninit
  ...
  type(nodeComponentDarkMatterProfileVTShape) :: darkMatterProfile

contains

  !# <nodeComponentInitializationTask>
  !#  <unitName>Node_Component_Dark_Matter_Profile_VT_Shape_Initialize</unitName>
  !# </nodeComponentInitializationTask>
  subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Initialize(parameters_)
    ...
    return
  end subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Initialize

  !# <nodeComponentThreadInitializationTask>
  !#  <unitName>Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Init</unitName>
  !# </nodeComponentThreadInitializationTask>
  subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Init(parameters_)
    ...
    if (defaultDarkMatterProfileComponent%vtShapeIsActive()) then
       !# <objectBuilder class="darkMatterProfileShape" name="darkMatterProfileShape_" source="parameters_"/>
       call nodePromotionEvent%attach(defaultDarkMatterProfileComponent,nodePromotion,openMPThreadBindingAtLevel,label='nodeComponentDarkMatterProfileVTShape')
    end if
    return
  end subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Init

  !# <nodeComponentThreadUninitializationTask>
  !#  <unitName>Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Uninit</unitName>
  !# </nodeComponentThreadUninitializationTask>
  subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Thread_Uninit()
  ...
  double precision function Node_Component_Dark_Matter_Profile_VT_Shape_Shape(self)
    !% Return the shape parameter in the dark matter halo profile.
    implicit none
    class(nodeComponentDarkMatterProfileVTShape), intent(inout) :: self
    ...
    Node_Component_Dark_Matter_Profile_VT_Shape_Shape=self%shapeValue()
    return
  end function Node_Component_Dark_Matter_Profile_VT_Shape_Shape

  !# <rateComputeTask>
  !#  <unitName>Node_Component_Dark_Matter_Profile_VT_Shape_Rate_Compute</unitName>
  !# </rateComputeTask>
  subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Rate_Compute(node,odeConverged,interrupt,interruptProcedure,propertyType)
    !% Compute the rate of change of the scale radius.
    use :: Galacticus_Nodes, only : defaultDarkMatterProfileComponent, nodeComponentDarkMatterProfile, nodeComponentDarkMatterProfileVTShape, propertyTypeInactive, &
          &                         treeNode
    implicit none
    ...
    if (.not.defaultDarkMatterProfileComponent%vtShapeIsActive()) return
    ! Get the dark matter profile component.
    darkMatterProfile => node%darkMatterProfile()
    ! Ensure that it is of the scale+shape class.
    select type (darkMatterProfile)
       class is (nodeComponentDarkMatterProfileVTShape)
       call darkMatterProfile%shapeRate(darkMatterProfile%shapeGrowthRate())
    end select
    return
  end subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Rate_Compute

  !# <mergerTreeInitializeTask>
  !#  <unitName>Node_Component_Dark_Matter_Profile_VT_Shape_Tree_Initialize</unitName>
  !#  <sortName>darkMatterProfile</sortName>
  !# </mergerTreeInitializeTask>
  subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Tree_Initialize(node)
    ...
    return
  end subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Tree_Initialize
  ...
  subroutine nodePromotion(self,node)
    ...
    use :: Galacticus_Nodes, only : nodeComponentBasic     , nodeComponentDarkMatterProfile, nodeComponentDarkMatterProfileVTShape, treeNode
    implicit none
  ...
  !# <scaleSetTask>
  !#  <unitName>Node_Component_Dark_Matter_Profile_VT_Shape_Scale_Set</unitName>
  !# </scaleSetTask>
  subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Scale_Set(node)
    ...
    return
  end subroutine Node_Component_Dark_Matter_Profile_VT_Shape_Scale_Set

end module Node_Component_Dark_Matter_Profile_VT_Shape
