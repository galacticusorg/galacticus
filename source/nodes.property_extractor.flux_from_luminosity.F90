...
!!}
  ...
  interface nodePropertyExtractorFluxFromLuminosity
     !!{
     Constructors for the ``fluxFromLuminosity'' output analysis class.
     !!}
...
contains
  ...
  function fluxFromLuminosityConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``fluxFromLuminosity'' output analysis property extractor class which takes a parameter set as input.
    !!}
  ...
  subroutine fluxFromLuminosityDestructor(self)
    !!{
    Destructor for the ``fluxFromLuminosity'' output analysis property extractor class.
    !!}
    implicit none
