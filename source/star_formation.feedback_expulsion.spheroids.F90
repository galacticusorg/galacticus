...
!% Contains a module which provides a class that implements expulsive feedback from star formation in spheroids.
...
module Star_Formation_Feedback_Expulsion_Spheroids
  ...
  !#  <descriptiveName>Epulsive feedback from star formation in spheroids</descriptiveName>
  !#  <description>Class providing models of expulsive feedback from star formation in spheroids.</description>
