...
module Interface_GSL
  ...
  <constant variable="GSL_ESing"    gslSymbol="GSL_ESING"    gslHeader="gsl_errno" type="integer" reference="Gnu Scientific Library" referenceURL="https://www.gnu.org/software/gsl/doc/html/err.html#error-codes" description="Error code for apparant singularity detected." group="GSL"/>
  ...
  <constant variable="GSL_EUndrFlw" gslSymbol="GSL_EUNDRFLW" gslHeader="gsl_errno" type="integer" reference="Gnu Scientific Library" referenceURL="https://www.gnu.org/software/gsl/doc/html/err.html#error-codes" description="Error code fo runderflow." group="GSL"/>
