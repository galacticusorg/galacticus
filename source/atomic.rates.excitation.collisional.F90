...
module Atomic_Rates_Excitation_Collisional
  ...
  <functionClass>
   ...
   <method name="coolingRate" >
    <description>Return the collisional excitation cooling rate , in units of J m$^3$ s$^{-1}$, for ion of given \source{atomicNumber} and \source{electronNumber} at temperature \source{T} (in Kelvin).</description>
