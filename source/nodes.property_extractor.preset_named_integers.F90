...
contains
  ...
  integer function presetNamedIntegersElementCount(self,time)
    !!{
    Return the number of elements in the \source{presetNamedIntegers} property extractors.
    !!}
    implicit none
  ...
  subroutine presetNamedIntegersNames(self,time,names)
    !!{
    Return the names of the \source{presetNamedIntegers} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorPresetNamedIntegers), intent(inout)                             :: self
    double precision                                          , intent(in   )                             :: time
  ...
  subroutine presetNamedIntegersDescriptions(self,time,descriptions)
    !!{
    Return the descriptions of the \source{presetNamedIntegers} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorPresetNamedIntegers), intent(inout)                             :: self
    double precision                                          , intent(in   )                             :: time
  ...
  function presetNamedIntegersUnitsInSI(self,time)
    !!{
    Return the units of the \source{presetNamedIntegers} properties in the SI system.
    !!}
    implicit none
