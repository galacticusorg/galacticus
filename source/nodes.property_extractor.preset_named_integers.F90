...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface nodePropertyExtractorPresetNamedIntegers
     !!{
     Constructors for the ``presetNamedIntegers'' output extractor class.
     !!}
...
contains
  ...
  function presetNamedIntegersConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``presetNamedIntegers'' property extractor class which takes a parameter set as input.
    !!}
  ...
  function presetNamedIntegersConstructorInternal(presetnames) result(self)
    !!{
    Internal constructor for the ``presetNamedIntegers'' output extractor property extractor class.
    !!}
    implicit none
    type   (nodePropertyExtractorPresetNamedIntegers)                              :: self
