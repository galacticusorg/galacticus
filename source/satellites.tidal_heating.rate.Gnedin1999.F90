...
!+    Contributions to this file made by:  Anthony Pullen, Andrew Benson.
  ...
  <satelliteTidalHeatingRate name="satelliteTidalHeatingRateGnedin1999">
   <description>
    ...
    $\epsilon=$\source{[epsilon]} and $\gamma=$\source{[gamma]} are model parameters, $g_{ij}$ is
...
contains
  ...
  function gnedin1999ConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      ...
      <description>Parameter, $\epsilon$, controlling the tidal heating rate of satellites in the \source{Gnedin1999} method.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
      <name>gamma</name>
      <defaultValue>2.5d0</defaultValue>
      <description>Parameter, $\gamma$, controlling the tidal heating rate of satellites in the \source{Gnedin1999} method.</description>
      <source>parameters</source>
    </inputParameter>
  ...
  subroutine gnedin1999Destructor(self)
    !!{
    Default constructor for the \source{gnedin1999} satellite tidal heating rate class.
    !!}
    implicit none
