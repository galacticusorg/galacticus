...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface nodePropertyExtractorGalaxyMergerTreeMergerPhysical
     !!{
     Constructors for the ``galaxyMergerTreeMergerPhysical'' output extractor class.
     !!}
...
contains
  ...
  function galaxyMergerTreeMergerPhysicalConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``galaxyMergerTreeMergerPhysical'' property extractor class which takes a parameter set as input.
    !!}
  ...
  function galaxyMergerTreeMergerPhysicalConstructorInternal() result(self)
    !!{
    Internal constructor for the ``galaxyMergerTreeMergerPhysical'' output extractor property extractor class.
    !!}
    implicit none
    type(nodePropertyExtractorGalaxyMergerTreeMergerPhysical) :: self
