...
contains
  ...
  subroutine localGroupStellarMassHaloMassRelationAnalyze(self,node,iOutput)
    !!{
    Implement a \source{localGroupStellarMassHaloMassRelation} output analysis.
    !!}
    implicit none
  ...
  subroutine localGroupStellarMassHaloMassRelationReduce(self,reduced)
    !!{
    Implement a \source{localGroupStellarMassHaloMassRelation} output analysis reduction.
    !!}
  ...
  subroutine localGroupStellarMassHaloMassRelationFinalize(self,groupName)
    !!{
    Implement a \source{localGroupStellarMassHaloMassRelation} output analysis finalization.
    !!}
    implicit none
    class(outputAnalysisLocalGroupStellarMassHaloMassRelation), intent(inout)           :: self
  ...
  double precision function localGroupStellarMassHaloMassRelationLogLikelihood(self)
    !!{
    Return the log-likelihood of a \source{localGroupStellarMassHaloMassRelation} output analysis.
    !!}
    implicit none
    class(outputAnalysisLocalGroupStellarMassHaloMassRelation), intent(inout) :: self
