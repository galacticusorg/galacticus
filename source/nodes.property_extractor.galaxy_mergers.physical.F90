...
contains
  ...
  subroutine galaxyMergersPhysicalNames(self,names)
    !!{
    Return the names of the \source{galaxyMergersPhysical} properties.
    !!}
    implicit none
    class(nodePropertyExtractorGalaxyMergersPhysical), intent(inout)                             :: self
  ...
  subroutine galaxyMergersPhysicalDescriptions(self,descriptions)
    !!{
    Return the descriptions of the \source{galaxyMergersPhysical} properties.
    !!}
    implicit none
    class(nodePropertyExtractorGalaxyMergersPhysical), intent(inout)                             :: self
  ...
  function galaxyMergersPhysicalUnitsInSI(self) result(unitsInSI)
    !!{
    Return the units of the \source{galaxyMergersPhysical} properties in the SI system.
    !!}
