...
module Cosmology_Parameters
  ...
  <functionClass>
   ...
   <method name="HubbleConstant" >
    <description>Return the Hubble constant at the present day. The optional \source{units} argument specifies if the return value should be in units of km/s/Mpc (hubbleUnitsStandard), Gyr$^{-1}$ (hubbleUnitsTime), or 100 km/s/Mpc (hubbleUnitsLittleH).</description>
    <type>double precision</type>
    <pass>yes</pass>
