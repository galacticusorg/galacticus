...
module Dark_Matter_Halo_Scales
  ...
  <functionClass docformat="rst">
   ...
   <method name="densityMean" >
    <description>
    Returns the mean interior density (in :math:`\mathrm{M}_\odot` Mpc\ :math:`^{-3}`) of the dark matter halo associated with ``node``, computed as the halo mass divided by its virial volume, representing the average density within the virial radius.
    </description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   ...
   <method name="densityMeanGrowthRate" >
    <description>
    Returns the time derivative of the mean interior density (in :math:`\mathrm{M}_\odot` Mpc\ :math:`^{-3}` Gyr\ :math:`^{-1}`) of the dark matter halo associated with ``node``, reflecting how the balance between mass accretion and volume growth changes over time.
    </description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
