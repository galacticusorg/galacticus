   ...
   <description>
    ...
    \begin{itemize}
     ...
     \begin{itemize}
      ...
      \ttfamily [destinationGasMinorMerger]} parameter (either ``\mono{disk}'' or ``{\normalfont \ttfamily
    ...
    considered to be ``major'', while $f_\mathrm{burst}=$\mono{[ratioMassBurst]} and
    $f_\mathrm{gas,crit}=$\mono{[fractionGasCriticalBurst]}.
   </description>
  </mergerMassMovements>
  !!]
