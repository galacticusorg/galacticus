...
contains
      ...
      do i=1,size(wavenumbersRestricted)
         ...
         if     (                         &
            ...
            block
              ...
              message='integration over interval failed'//char(10)//displayGreen()//'HELP:'//displayReset()//' try increasing the value of the tolerance in your parameter file as highlighted below:'//char(10)//char(10)
              if (useTopHat) then
  ...
  subroutine filteredPowerFileWrite(self)
    ...
    ! Open the data file.
    !$ call hdf5Access%set()
    dataFile=hdf5Object(char(self%fileName),overWrite=.true.,objectsOverwritable=.true.,chunkSize=100_hsize_t,compressionLevel=9)
