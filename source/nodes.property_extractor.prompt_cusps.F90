...
contains
  ...
  integer function promptCuspsElementCount(self,time)
    !!{
    Return the number of elements in the \source{promptCusps} property extractors.
    !!}
    implicit none
  ...
  function promptCuspsExtract(self,node,time,instance)
    !!{
    Implement a \source{promptCusps} property extractor.
    !!}
  ...
  subroutine promptCuspsNames(self,time,names)
    !!{
    Return the names of the \source{promptCusps} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorPromptCusps), intent(inout)                             :: self
    double precision                                  , intent(in   )                             :: time
  ...
  subroutine promptCuspsDescriptions(self,time,descriptions)
    !!{
    Return descriptions of the \source{promptCusps} property.
    !!}
    implicit none
    class           (nodePropertyExtractorPromptCusps), intent(inout)                             :: self
    double precision                                  , intent(in   )                             :: time
  ...
  function promptCuspsUnitsInSI(self,time)
    !!{
    Return the units of the \source{PromptCusps} properties in the SI system.
    !!}
