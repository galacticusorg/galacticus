...
module Constraints_Priors
  ...
  type, public :: prior
   ...
   contains
     ...
     !@     <description>Sample from the prior, populating the given {\normalfont \ttfamily state}.</description>
     !@   </objectMethod>
     !@   <objectMethod>
     !@     <method>logDensity</method>
     !@     <type>\doublezero</type>
     !@     <arguments>\textcolor{red}{\textless class(state)\textgreater} simulationState\argin</arguments>
     !@     <description>Return the log of the probability density of the prior at the given {\normalfont \ttfamily simulationState}.</description>
     !@   </objectMethod>
     !@   <objectMethod>
  ...
  interface prior
     !% Interface to constructors for the {\normalfont \ttfamily prior} class.
...
contains
  ...
  subroutine priorSample(self,state)
    !% Sample from the prior, populating the given {\normalfont \ttfamily state}.
    implicit none
  ...
  subroutine priorsSample(priors,priorState)
    !% Sample from all priors populating the given {\normalfont \ttfamily priorState}.
  ...
  double precision function priorInvert(self,p)
    !% Return the value of the prior given the cumulative probability, {\normalfont \ttfamily p}.
