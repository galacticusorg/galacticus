...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <enumeration>
   ...
   <description>Enumerates the samples available in the \source{gordon2003} dust attenuation class.</description>
...
contains
  ...
  function gordon2003ConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{gordon2003} stellar spectra dust attenuation class.
    !!}
