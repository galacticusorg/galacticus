...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface mergerTreeEvolveTimestepSimple
     !!{RST
     Constructors for the ``mergerTreeEvolveTimestepSimple`` merger tree evolution timestep class.
     !!}
...
contains
  ...
  function simpleConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the ``mergerTreeEvolveTimestepSimple`` merger tree evolution timestep class which takes a parameter set as input.
    !!}
  ...
  subroutine simpleDestructor(self)
    !!{RST
    Destructor for the ``mergerTreeEvolveTimestepSimple`` merger tree evolution timestep class.
    !!}
    implicit none
