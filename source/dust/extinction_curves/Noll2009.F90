...
!+    Contributions to this file made by: Andrew Benson, Claude.
  ...
  <dustExtinctionCurve name="dustExtinctionCurveNoll2009" docformat="rst">
   ...
   :cite:t:`calzetti_dust_2000` curve with a variable-strength :math:`2175\,\text{Å}` absorption bump and an adjustable
   overall slope:
   ...
   with :math:`\lambda_0=2175\,\text{Å}` and :math:`\Delta\lambda=350\,\text{Å}`. Setting ``bumpStrength`` and ``slope`` to zero
   ...
   Because the underlying :cite:t:`calzetti_dust_2000` curve returns zero outside :math:`0.12`--:math:`2.20\,\mu\mathrm{m}`,
   so does this one.
   </description>
  </dustExtinctionCurve>
  !!]
...
contains
  ...
  function noll2009ConstructorParameters(parameters) result(self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The amplitude :math:`E_\mathrm{b}` of the :math:`2175\,\text{Å}` bump in the :cite:t:`noll_analysis_2009` attenuation
