...
contains
  ...
  function axionCambConstructorParameters(parameters) result(self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The number of points per decade of wavenumber to compute in the AxionCAMB transfer function. A value of 0 allows AxionCAMB to choose what it considers to be optimal spacing of wavenumbers.
      </description>
    </inputParameter>
  ...
  subroutine axionCambCheckRange(self,wavenumber)
    !!{RST
    Check that the provided wavenumber is within the tabulated range and, if not, recompute the AxionCAMB transfer function.
    !!}
