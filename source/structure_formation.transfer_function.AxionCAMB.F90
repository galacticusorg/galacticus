...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <transferFunction name="transferFunctionAxionCAMB">
   <description>
    ...
    cosmological parameters. The transfer function is written out to a file in the \mono{data/dynamic/largeScaleStructure} directory and will be re-read later if needed. {\normalfont
