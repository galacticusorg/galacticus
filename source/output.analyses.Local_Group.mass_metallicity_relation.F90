...
contains
  ...
  subroutine localGroupMassMetallicityRelationAnalyze(self,node,iOutput)
    !!{
    Implement a \source{localGroupMassMetallicityRelation} output analysis.
    !!}
    implicit none
  ...
  subroutine localGroupMassMetallicityRelationReduce(self,reduced)
    !!{
    Implement a \source{localGroupMassMetallicityRelation} output analysis reduction.
    !!}
  ...
  subroutine localGroupMassMetallicityRelationFinalize(self,groupName)
    !!{
    Implement a \source{localGroupMassMetallicityRelation} output analysis finalization.
    !!}
    implicit none
    class(outputAnalysisLocalGroupMassMetallicityRelation), intent(inout)           :: self
  ...
  double precision function localGroupMassMetallicityRelationLogLikelihood(self)
    !!{
    Return the log-likelihood of a \source{localGroupMassMetallicityRelation} output analysis.
    !!}
    implicit none
    class(outputAnalysisLocalGroupMassMetallicityRelation), intent(inout) :: self
