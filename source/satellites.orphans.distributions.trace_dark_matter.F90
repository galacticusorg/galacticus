...
contains
  ...
  double precision function traceDarkMatterExtent(self,node)
    !!{
    Return the maximum extent of the orphan satellite population for the \source{traceDarkMatter} orphan
  ...
  double precision function traceDarkMatterInverseCMFRadial(self,node,fraction)
    !!{
    Return the radial coordinate within which the given \source{fraction} of orphan satellites are found.
    !!}
