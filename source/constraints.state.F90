...
module Constraints_State
  ...
  type, abstract, public :: state
   ...
   contains
     ...
     !@     <description>Update the current state to the specified new state. Only log this state (i.e. increase step count etc.) if the {\normalfont \ttfamily logState} argument is true.</description>
     !@   </objectMethod>
     !@   <objectMethod>
     !@     <method>mean</method>
