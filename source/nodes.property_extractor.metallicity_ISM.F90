...
!!}
  ...
  interface nodePropertyExtractorMetallicityISM
     !!{RST
     Constructors for the ``nodePropertyExtractorMetallicityISM`` property extractor class.
     !!}
...
contains
  ...
  function metallicityISMConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the ``nodePropertyExtractorMetallicityISM`` property extractor class which takes a parameter set as input.
    !!}
  ...
  function metallicityISMConstructorInternal(indexElement) result(self)
    !!{RST
    Internal constructor for the ``nodePropertyExtractorMetallicityISM`` property extractor class.
    !!}
