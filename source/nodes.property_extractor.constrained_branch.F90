...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <nodePropertyExtractor name="nodePropertyExtractorConstrainedStatus">
   <description>
    ...
    extracted as \source{nodeIsConstrained}, with a value of 1 indicating that the node follows the constrained
...
contains
  ...
  function constrainedStatusExtract(self,node,time,instance)
    !!{
    Implement a \source{constrainedStatus} node property extractor.
    !!}
