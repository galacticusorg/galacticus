...
contains
 ...
 function String_Value_Type(input) result(valueType)
  ...
  function stringXMLFormat(stringIn,indentStep,indentInitial,forceColor) result (stringOut)
    !!{
    Format an XML string with pretty indentation and coloring.
    !!}
