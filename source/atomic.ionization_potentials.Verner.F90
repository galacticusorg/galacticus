...
contains
  ...
  double precision function vernerPotential(self,atomicNumber,electronNumber)
    !!{
    Return the ionization potential (in units of electron volts) for the ion with given \source{atomicNumber} and
    \source{electronNumber} using data taken from Dima Verner's
