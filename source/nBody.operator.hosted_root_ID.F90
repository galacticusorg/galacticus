...
contains
  ...
  function hostedRootIDConstructorParameters(parameters) result (self)
    ...
    <inputParameter>
      ...
      <description>If true, if a halo is not found during the search through hosts and descendants then a fatal error occurs. Otherwise, such missing halos are ignored, and a \source{hostedRootID} value of $-1$ is assigned to the particle.</description>
    </inputParameter>
    !!]
