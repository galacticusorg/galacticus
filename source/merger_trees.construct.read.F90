...
contains
  ...
  function readConstructorParameters(parameters) result(self)
    ...
    <inputParameter docformat="rst">
      ...
      <defaultValue>.true.</defaultValue>
      <description>
      Specifies whether nodes with missing host nodes should be considered to be fatal---see the discussion of missing host nodes in the class description above.
      </description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter docformat="rst">
