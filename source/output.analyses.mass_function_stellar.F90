...
!!}
  ...
  !![
  <outputAnalysis name="outputAnalysisMassFunctionStellar" docformat="rst">
   <description>
...
contains
  ...
  function massFunctionStellarConstructorParameters(parameters) result (self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The number of bins per decade of halo mass to use when constructing stellar mass function covariance matrices for main branch galaxies.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      ...
      <description>
      The minimum halo mass to consider when constructing stellar mass function covariance matrices for main branch galaxies.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      ...
      <description>
      The maximum halo mass to consider when constructing stellar mass function covariance matrices for main branch galaxies.
      </description>
    </inputParameter>
    !!]
