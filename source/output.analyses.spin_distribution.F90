  ...
  function spinDistributionConstructorParameters(parameters) result (self)
    ...
    if (parameters%isPresent('fileName')) then
       ...
       <inputParameter>
         ...
         <source>parameters</source>
         <description>Halos which experienced a major node merger within a time $\Delta t=$\source{[timeRecent]} of the analysis time will be excluded from the analysis.</description>
       </inputParameter>
       <inputParameter>
