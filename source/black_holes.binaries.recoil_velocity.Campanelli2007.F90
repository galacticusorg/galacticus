...
!+    Contributions to this file made by:  Stéphane Mangeon, Andrew Benson.
  ...
  !!{RST
  Implements a black hole binary recoil velocity class which follows the formulae in :cite:t:`campanelli_large_2007`, derived from post-Newtonian evaluations.
  !!}

  !![
  <blackHoleBinaryRecoil name="blackHoleBinaryRecoilCampanelli2007" docformat="rst">
   <description>
   A black hole binary recoil class that computes the recoil velocity during a black hole binary merger due to the emission of gravitational waves, following the formulae derived in :cite:t:`campanelli_large_2007`
...
contains
  ...
  double precision function campanelli2007Velocity(self,blackHole1,blackHole2)
    !!{RST
    Returns the recoil velocity of a black hole binary, accounting for the parallel and perpendicular velocities, plus that of the binary's center of mass. Constants used are retrieved from the articles by: :cite:t:`koppitz_recoil_2007` for :math:`H=(7.3\pm 0.3)10^3` km/s, :cite:t:`gonzalez_maximum_2007` for :math:`A=1.2 \times 10^4` km/s :math:`B=-0.93`, :cite:t:`gonzalez_supermassive_2007` for :math:`K \cos(\delta\theta)=(6,-5.3)10^4` km/s and :math:`K=(6.0\pm 0.1)10^4` km/s.
    !!}
