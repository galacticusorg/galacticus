...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <satelliteMergingTimescales name="satelliteMergingTimescalesLaceyCole1993Tormen">
   <description>
    ...
    \source{mergingTimescaleMultiplier} input parameter. Specifically, the merging time is taken to be:
    \begin{equation}
    ...
    \end{equation}
    where $f_\tau=$\source{mergingTimescaleMultiplier}, $\tau_\mathrm{dynamical}$ is the dynamical time of the
