...
contains
  ...
  integer function projectedDensityElementCount(self,time)
    !!{
    Return the number of elements in the \source{projectedDensity} property extractors.
    !!}
    implicit none
  ...
  function projectedDensitySize(self,time)
    !!{
    Return the number of array elements in the \source{projectedDensity} property extractors.
    !!}
    implicit none
  ...
  function projectedDensityExtract(self,node,time,instance) result(densityProjected)
    !!{
    Implement a \source{projectedDensity} property extractor.
    !!}
  ...
  subroutine projectedDensityNames(self,names,time)
    !!{
    Return the names of the \source{projectedDensity} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorProjectedDensity), intent(inout)                             :: self
  ...
  subroutine projectedDensityDescriptions(self,descriptions,time)
    !!{
    Return descriptions of the \source{projectedDensity} property.
    !!}
    implicit none
    class           (nodePropertyExtractorProjectedDensity), intent(inout)                             :: self
    double precision                                       , intent(in   ), optional                   :: time
  ...
  subroutine projectedDensityColumnDescriptions(self,descriptions,values,valuesDescription,valuesUnitsInSI,time)
    !!{
    Return column descriptions of the \source{projectedDensity} property.
    !!}
    implicit none
    class           (nodePropertyExtractorProjectedDensity), intent(inout)                            :: self
    double precision                                       , intent(in   ), optional                  :: time
  ...
  function projectedDensityUnitsInSI(self,time)
    !!{
    Return the units of the \source{projectedDensity} properties in the SI system.
    !!}
