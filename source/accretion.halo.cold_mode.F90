...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <accretionHalo name="accretionHaloColdMode">
   <description>
    ...
    accretion. This class extends the \source{simple} class by dividing the accretion into hot and cold mode
    ...
    \end{equation}
    where $\delta=$\source{[accretionColdModeShockStabilityTransitionWidth]}, $r =
...
contains
  ...
  function coldModeConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{coldMode} halo accretion class.
    !!}
