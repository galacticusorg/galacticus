...
!!}
  ...
  interface nodePropertyExtractorRadiusHalfMassGalactic
     !!{
     Constructors for the {\normalfont \ttfamily radiusHalfMassGalactic} output analysis class.
     !!}
...
contains
  ...
  function radiusHalfMassGalacticConstructorParameters(parameters) result(self)
    !!{
    Constructor for the {\normalfont \ttfamily radiusHalfMassGalactic} output analysis property extractor class which takes a parameter set as input.
    !!}
