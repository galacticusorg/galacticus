...
module Stellar_Population_Broad_Band_Luminosities
  ...
  <functionClass>
   ...
   <method name="luminosities" >
    <description>Returns the luminosity for a $1 M_\odot$ simple \source{stellarPopulation\_} of given \source{abundances} and \source{age} and observed through the filter specified by \source{filterIndex}.</description>
   ...
   <method name="luminosityTracks" >
    <description>Returns the luminosity for a $1 M_\odot$ simple stellar population of given \source{abundances} drawn from the given \source{stellarPopulation} and observed through the filter specified by \source{filterIndex}, for all available ages.</description>
    <type>void</type>
    <pass>yes</pass>
    <argument>integer                                                    , intent(in   ), dimension(:  )              :: luminosityIndex                       , filterIndex</argument>
    <argument>type            (stellarPopulationSpectraPostprocessorList), intent(inout), dimension(:  )              :: stellarPopulationSpectraPostprocessor_             </argument>
