...
!!}
  ...
  <nodePropertyExtractor name="nodePropertyExtractorStarFormationRate">
   <description>
    ...
    the \source{[component]} parameter, which can be either ``\source{disk}'', ``{\normalfont
    \ttfamily spheroid}'', ``\source{nsc}'' or ``\source{total}''. The corresponding star formation
    rate is extracted as \source{\textless\ component\textgreater\ StarFormationRate} in units of $M_\odot$/Gyr.
   </description>
