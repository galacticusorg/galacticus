...
contains
  ...
  double precision function bhattacharya2011A(self,time,mass)
    !!{
    Return the parameter $\bar{a}$ in the \source{bhattacharya2011} halo mass function at the given time and mass.
    !!}
    implicit none
  ...
  double precision function bhattacharya2011P(self,time,mass)
    !!{
    Return the parameter $\bar{p}$ in the \source{bhattacharya2011} halo mass function at the given time and mass.
    !!}
    implicit none
    class           (haloMassFunctionBhattacharya2011), intent(inout) :: self
    double precision                                  , intent(in   ) :: time , mass
  ...
  double precision function bhattacharya2011Q(self,time,mass)
    !!{
    Return the parameter $\bar{q}$ in the \source{bhattacharya2011} halo mass function at the given time and mass.
    !!}
    implicit none
    class           (haloMassFunctionBhattacharya2011), intent(inout) :: self
    double precision                                  , intent(in   ) :: time , mass
  ...
  double precision function bhattacharya2011Normalization(self,time,mass)
    !!{
    Return the normalization, $\bar{A}$, in the \source{bhattacharya2011} halo mass function at the given time and mass.
    !!}
    implicit none
    class           (haloMassFunctionBhattacharya2011), intent(inout) :: self
    double precision                                  , intent(in   ) :: time , mass
