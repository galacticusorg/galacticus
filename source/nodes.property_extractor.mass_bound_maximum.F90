...
contains
  ...
  function massBoundMaximumName(self)
    !!{
    Return the names of the \source{massBoundMaximum} properties.
    !!}
    implicit none
  ...
  function massBoundMaximumDescription(self)
    !!{
    Return the descriptions of the \source{massBoundMaximum} properties.
    !!}
    implicit none
  ...
  double precision function massBoundMaximumUnitsInSI(self)
    !!{
    Return the units of the \source{massBoundMaximum} properties in the SI system.
    !!}
