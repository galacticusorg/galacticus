...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  !!{RST
  Implements an excursion set barrier class which remaps another class using the :cite:t:`sheth_ellipsoidal_2001` ellipsoidal collapse parameterization.
  !!}

  !![
  <excursionSetBarrier name="excursionSetBarrierRemapShethMoTormen" docformat="rst">
   <description>
   An excursion set barrier class which remaps another class using the :cite:t:`sheth_ellipsoidal_2001` ellipsoidal collapse parameterization:

   .. math::

      B(S) \rightarrow \sqrt{A} B(S) \left(1 + b \left[ {S \over A B^2(S)}\right]^c\right),

   where :math:`A=0.707`, :math:`b=0.5`, and :math:`c=0.6`.
   </description>
  </excursionSetBarrier>
  !!]
...
contains
  ...
  function remapShethMoTormenConstructorParameters(parameters) result(self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      The parameter :math:`a` in the :cite:t:`sheth_ellipsoidal_2001` ellipsoidal collapse excursion set barrier remapping.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      <name>b</name>
      ...
      <description>
      The parameter :math:`b` in the :cite:t:`sheth_ellipsoidal_2001` ellipsoidal collapse excursion set barrier remapping.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      <name>c</name>
      ...
      <description>
      The parameter :math:`c` in the :cite:t:`sheth_ellipsoidal_2001` ellipsoidal collapse excursion set barrier remapping.
      </description>
    </inputParameter>
    <inputParameter docformat="rst">
      <name>applyTo</name>
