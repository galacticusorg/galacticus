...
contains
  ...
  subroutine cambCheckRange(self,wavenumber)
    !!{RST
    Check that the provided wavenumber is within the tabulated range and, if not, recompute the CAMB transfer function.
    !!}
