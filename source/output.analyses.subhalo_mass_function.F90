...
contains
  ...
  subroutine subhaloMassFunctionAnalyze(self,node,iOutput)
    !!{
    Implement a \source{subhaloMassFunction} output analysis.
    !!}
    implicit none
  ...
  subroutine subhaloMassFunctionReduce(self,reduced)
    !!{
    Implement a \source{subhaloMassFunction} output analysis reduction.
    !!}
  ...
  subroutine subhaloMassFunctionFinalizeAnalysis(self)
    !!{
    Finalize analysis of a \source{subhaloMassFunction} output analysis.
    !!}
    implicit none
    class           (outputAnalysisSubhaloMassFunction), intent(inout)               :: self
  ...
  subroutine subhaloMassFunctionFinalize(self,groupName)
    !!{
    Implement a \source{subhaloMassFunction} output analysis finalization.
    !!}
  ...
  double precision function subhaloMassFunctionLogLikelihood(self)
    !!{
    Return the log-likelihood of a \source{subhaloMassFunction} output analysis. The likelihood function
