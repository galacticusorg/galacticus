...
program Tests_Cosmic_Age_EdS
  !% Tests cosmic age calculations for an Einstein-de Sitter Universe. Ages calculated using Python implementation of Ned Wright's
  ...
  ! Begin unit tests.
  call Unit_Tests_Begin_Group("Cosmic age: Einstein-de Sitter cosmology")

  ! Test cosmic age in an Einstein-de Sitter universe.
...
end program Tests_Cosmic_Age_EdS
