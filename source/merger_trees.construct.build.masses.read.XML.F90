  ...
  <mergerTreeBuildMasses name="mergerTreeBuildMassesReadXML">
   <description>
    ...
    \begin{verbatim}
     ...
     &lt;/mergerTrees>
    \end{verbatim}
    where each \source{treeRootMass} element gives the mass (in Solar masses) of the root halo of a tree to
    generate, and the (optional) \source{treeWeight} elements give the corresponding weight (in units of
