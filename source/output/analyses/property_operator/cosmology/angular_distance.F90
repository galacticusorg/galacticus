...
!!}
  ...
  type, extends(outputAnalysisPropertyOperatorClass) :: outputAnalysisPropertyOperatorCsmlgyAnglrDstnc
   ...
   contains
     ...
     procedure :: isOutputDependent => csmlgyAnglrDstncIsOutputDependent
...
contains
  ...
  logical function csmlgyAnglrDstncIsOutputDependent(self) result(isOutputDependent)
    !!{RST
    ...
    return
  end function csmlgyAnglrDstncIsOutputDependent
