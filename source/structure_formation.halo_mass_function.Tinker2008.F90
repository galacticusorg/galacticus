...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <enumeration>
   ...
   <description>Enumeration of parameters for the \source{tinker2008} halo mass function class.</description>
...
contains
  ...
  subroutine tinker2008ParametersEvaluate(self,time,mass)
    !!{
    Evaluate interpolating parameters for the \source{tinker2008} halo mass function class.
    !!}
    implicit none
  ...
  double precision function tinker2008Normalization(self,time,mass)
    !!{
    Return the normalization for the \source{tinker2008} halo mass function class.
    !!}
    implicit none
    class           (haloMassFunctionTinker2008), intent(inout) :: self
    double precision                            , intent(in   ) :: time           , mass
