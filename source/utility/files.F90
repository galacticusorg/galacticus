...
!: $(BUILDPATH)/system/flock.o $(BUILDPATH)/system/mkdir.o $(BUILDPATH)/system/unlink.o $(BUILDPATH)/system/rmdir.o $(BUILDPATH)/system/rename.o $(BUILDPATH)/system/access.o
