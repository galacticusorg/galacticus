...
module Cooling_Freefall_Times_Available
  ...
  <functionClass>
   ...
   <method name="timeAvailable" >
    <description>Returns the time available for freefall in cooling calculations in \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
   <method name="timeAvailableIncreaseRate" >
    <description>Returns the rate at which the time available for freefall in cooling calculations increases in \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
