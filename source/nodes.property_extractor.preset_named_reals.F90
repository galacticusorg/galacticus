...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface nodePropertyExtractorPresetNamedReals
     !!{
     Constructors for the ``presetNamedReals'' output extractor class.
     !!}
...
contains
  ...
  function presetNamedRealsConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``presetNamedReals'' property extractor class which takes a parameter set as input.
    !!}
  ...
  function presetNamedRealsConstructorInternal(presetnames) result(self)
    !!{
    Internal constructor for the ``presetNamedReals'' output extractor property extractor class.
    !!}
    implicit none
    type   (nodePropertyExtractorPresetNamedReals)                              :: self
