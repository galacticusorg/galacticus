...
contains
  ...
  subroutine Cosmology_Functions_Matter_Dark_Energy_Initialize(cosmologyMethod,Expansion_Factor_Is_Valid_Get,Cosmic_Time_Is_Valid_Get &
    ...
    procedure       (Early_Time_Density_Scaling_Matter_Dark_Energy          ), pointer, intent(inout) :: Early_Time_Density_Scaling_Get
    procedure       (Expansion_Factor_Is_Valid_Matter_Dark_Energy           ), pointer, intent(inout) :: Expansion_Factor_Is_Valid_Get
    procedure       (Cosmic_Time_Is_Valid_Matter_Dark_Energy                ), pointer, intent(inout) :: Cosmic_Time_Is_Valid_Get
    procedure       (Cosmology_Age_Matter_Dark_Energy                       ), pointer, intent(inout) :: Cosmology_Age_Get 
    procedure       (Expansion_Factor_Matter_Dark_Energy                    ), pointer, intent(inout) :: Expansion_Factor_Get
    procedure       (Hubble_Parameter_Matter_Dark_Energy                    ), pointer, intent(inout) :: Hubble_Parameter_Get 
    procedure       (Omega_Matter_Total_Matter_Dark_Energy                  ), pointer, intent(inout) :: Omega_Matter_Total_Get
    procedure       (Omega_Dark_Energy_Matter_Dark_Energy                   ), pointer, intent(inout) :: Omega_Dark_Energy_Get 
    procedure       (Expansion_Rate_Matter_Dark_Energy                      ), pointer, intent(inout) :: Expansion_Rate_Get
    procedure       (Epoch_of_Matter_Dark_Energy_Equality_Matter_Dark_Energy), pointer, intent(inout) :: Epoch_of_Matter_Dark_Energy_Equality_Get 
    procedure       (Epoch_of_Matter_Domination_Matter_Dark_Energy          ), pointer, intent(inout) :: Epoch_of_Matter_Domination_Get 
    procedure       (Epoch_of_Matter_Curvature_Equality_Matter_Dark_Energy  ), pointer, intent(inout) :: Epoch_of_Matter_Curvature_Equality_Get
    procedure       (CMB_Temperature_Matter_Dark_Energy                     ), pointer, intent(inout) :: CMB_Temperature_Get
    procedure       (Comoving_Distance_Matter_Dark_Energy                   ), pointer, intent(inout) :: Comoving_Distance_Get
    procedure       (Time_From_Comoving_Distance_Matter_Dark_Energy         ), pointer, intent(inout) :: Time_From_Comoving_Distance_Get
    procedure       (Comoving_Distance_Conversion_Matter_Dark_Energy        ), pointer, intent(inout) :: Comoving_Distance_Conversion_Get
    procedure       (Cosmology_Dark_Energy_Equation_Of_State_Dark_Energy    ), pointer, intent(inout) :: Cosmology_Dark_Energy_Equation_Of_State_Get
    procedure       (Cosmology_Dark_Energy_Exponent_Dark_Energy             ), pointer, intent(inout) :: Cosmology_Dark_Energy_Exponent_Get
  ...
  subroutine Make_Expansion_Factor_Table(tCosmological)
    ...
    double precision                            :: densityPower,aDominant,Omega_Dominant,tDominant,time,aExpansion(1),deltaTime
  ...
  double precision function Expansion_Factor_Change(timeStart,timeEnd,expansionFactorStart)
    ...
    use ODE_Solver
    implicit none
    double precision       , intent(in   ) :: timeStart,timeEnd,expansionFactorStart
  ...
  function ageTableODEsDarkEnergy(t,a,dadt,parameterPointer) bind(c)
    ...
    integer(c_int)                           :: ageTableODEsDarkEnergy
  ...
  double precision function Epoch_of_Matter_Domination_Matter_Dark_Energy(dominateFactor)
    ...
    double precision                             :: aMatterEquality,aDominantDarkEnergy,aDominantCurvature,rangeExpandUpward&
         &,rangeExpandDownward,darkEnergyExponentCurrent
  ...
  double precision function Epoch_of_Matter_Dark_Energy_Equality_Matter_Dark_Energy(requestType)
    ...
    double precision                          :: rangeExpandUpward,rangeExpandDownward,darkEnergyExponentCurrent
