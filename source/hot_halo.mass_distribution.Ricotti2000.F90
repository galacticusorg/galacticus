...
contains
  ...
  function ricotti2000ConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{ricotti2000} hot halo mass distribution class.
    !!}
  ...
  function ricotti2000Get(self,node,weightBy,weightIndex) result(massDistribution_)
    !!{
    Return the \source{ricotti2000} hot halo mass distribution for the given \source{node}.
    !!}
