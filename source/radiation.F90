...
module Radiation_Fields
  ...
  <functionClass>
   ...
   <method name="integrateOverCrossSection">
    <description>Integrates the flux (in units of ergs cm$^{-2}$ s$^{-1}$ Hz$^{-1}$ ster$^{-1}$) of the given radiation structure between the wavelengths given in \source{wavelengthRange} over a cross section specified by the function \source{crossSectionFunction}.</description>
    <type>double precision</type>
    <pass>yes</pass>
