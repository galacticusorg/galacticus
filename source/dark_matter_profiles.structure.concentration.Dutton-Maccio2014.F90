...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <enumeration>
   ...
   <description>Enumeration of fit types in the \source{duttonMaccio2014} dark matter halo profile concentration class.</description>
  ...
  <enumeration>
   ...
   <description>Enumeration of density contrast methods available in the \source{duttonMaccio2014} dark matter halo profile concentration class.</description>
  ...
  <enumeration>
   ...
   <description>Enumeration of density profile methods available in the \source{duttonMaccio2014} dark matter halo profile concentration class.</description>
   <visibility>private</visibility>
   <entry label="NFW"    />
   <entry label="einasto"/>
  </enumeration>
  ...
  <darkMatterProfileConcentration name="darkMatterProfileConcentrationDuttonMaccio2014">
   <description>
    ...
    {\boldmath $B_2$} \\
    \hline
    \source{nfwVirial}  &amp; \gls{nfw} &amp; Top-hat &amp; $+0.537$ &amp; $+1.025$ &amp; $-0.718$ &amp; $+1.080$ &amp; $-0.097$ &amp; $+0.024$ \\
    \source{nfw200}     &amp; \gls{nfw} &amp; 200     &amp; $+0.520$ &amp; $+0.905$ &amp; $-0.617$ &amp; $+1.210$ &amp; $-0.101$ &amp; $+0.026$ \\
    \source{einasto200} &amp; Einasto   &amp; 200     &amp; $+0.459$ &amp; $+0.977$ &amp; $-0.490$ &amp; $+1.303$ &amp; $-0.130$ &amp; $+0.029$ \\
    \hline
    \end{tabular}
    \end{center}
    \caption{Coefficients appearing in the dark matter halo profile concentration fitting functions of
    \protect\cite{dutton_cold_2014}. The ``fit type'' is specified by the \source{[duttonMaccio2014FitType]}
    parameter.}
...
contains
  ...
  function duttonMaccio2014ConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{duttonMaccio2014} dark matter halo profile concentration class.
    !!}
    implicit none
    ...
    <inputParameter>
      ...
      <description>The type of halo definition for which the concentration-mass relation should be computed. Allowed values are \source{nfwVirial}, \source{nfwCritical200}, \source{einastoCritical200}, and \source{userDefined}.</description>
    </inputParameter>
    !!]
  ...
  double precision function duttonMaccio2014Concentration(self,node)
    !!{
    Return the concentration of the dark matter halo profile of \source{node} using the \cite{dutton_cold_2014}
    algorithm.
    !!}
