...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <description>
      ...
      Halos for which the change in mass is less than \source{[sigmaThreshold]} times the uncertainty in the
      ...
      \end{equation}
      where $\alpha=$\source{[exponentGrowth]}, $M_1$ is the mass of a primary progenitor halo, $M_2$ is the mass
