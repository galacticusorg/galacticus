...
!!}
  ...
  <nodePropertyExtractor name="nodePropertyExtractorRedshiftLastIsolated">
   <description>A node property extractor class which extracts the redshift at which a \gls{node} was last isolated---named ``\source{redshiftLastIsolated}''.</description>
