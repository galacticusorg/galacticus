...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  !!{RST
  Implements a black hole binary separation growth class which follows a modified version of :cite:t:`volonteri_assembly_2003`, including terms for dynamical friction, hardening due to scattering of stars and emission of gravitational waves.
  !!}

  use :: Dark_Matter_Halo_Scales, only : darkMatterHaloScaleClass

  !![
  <blackHoleBinarySeparationGrowthRate name="blackHoleBinarySeparationGrowthRateStandard" docformat="rst">
   <description>
   A black hole binary separation growth class that computes the separation growth rate of the binaries following a modified version of :cite:t:`volonteri_assembly_2003` which include terms for dynamical friction, hardening due to scattering of stars and gravitational wave emission.
   ...
   where the sum is taken over the spheroid (gaseous plus stellar mass) and dark matter halo components\footnoteThe disk is ignored as the black hole is assumed to be orbiting in a circular orbit in the disk.. Here,
   ...
   In calculating the rate of hardening due to scattering of stars, the stellar density is reduced by a factor :cite:p:`volonteri_assembly_2003`
  ...
  type, extends(blackHoleBinarySeparationGrowthRateClass) :: blackHoleBinarySeparationGrowthRateStandard
     !!{RST
     A black hole binary separation growth class which follows a modified version of :cite:t:`volonteri_assembly_2003`, including terms for dynamical friction, hardening due to scattering of stars and emission of gravitational waves.
     !!}
     private
...
contains
  ...
  function standardConstructorParameters(parameters) result(self)
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      If true, account for the change in stellar density caused by the black hole binary's motion through the stellar background when computing the hardening rate of the binary via stellar scattering.
      </description>
    ...
    <inputParameter docformat="rst">
      ...
      <description>
      Specifies whether or not the velocity dispersion of dark matter and stars should be computed using Jeans equation in black hole binary hardening calculations. If ``false``, then the velocity dispersions are assumed to equal the characteristic velocity of dark matter and spheroid.
      </description>
      <source>parameters</source>
    </inputParameter>
  ...
  double precision function standardGrowthRate(self,blackHole)
    !!{RST
    Returns an initial separation growth rate for a binary black holes that follows a modified version of :cite:t:`volonteri_assembly_2003`.
    !!}
