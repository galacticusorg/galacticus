...
!!{RST
Contains a program which tests spherical collapse calculations for a dark energy Universe, specifically using a flat, :math:`\omega=-1/2` cosmology.
!!}

program Tests_Spherical_Collapse_Dark_Energy_Omega_Half
  !!{RST
  Tests spherical collapse calculations for a dark energy Universe, specifically using a flat, :math:`\omega=-1/2` cosmology. Compares results to the fitting function of :cite:author:`weinberg_constraining_2003` (:cite:year:`weinberg_constraining_2003`; eqn. 18).
  !!}
  ...
  <referenceConstruct object="cosmologyFunctions_"                >
   <constructor>
    cosmologyFunctionsMatterDarkEnergy                     (                                                                             &amp;
     ...
     &amp;                                                  darkEnergyEquationOfStateW0        =-0.5d0                                ,  &amp;
