...
!!{RST
Contains a program which tests spherical collapse calculations for a dark energy Universe, specifically using a flat, :math:`\omega=-0.8` cosmology.
!!}

program Tests_Spherical_Collapse_Dark_Energy_Omega_Zero_Point_Eight
  !!{RST
  Tests spherical collapse calculations for a dark energy Universe, specifically using a flat, :math:`\omega=-0.8` cosmology. Compares results to points read from Figure 6 of :cite:t:`horellou_dark_2005` using `DataThief <http://datathief.org/>`_.
  !!}
