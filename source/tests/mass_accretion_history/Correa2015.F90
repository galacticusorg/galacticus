...
!!{RST
Contains a program which tests the :cite:t:`correa_accretion_2015` halo mass formation history.
!!}

program Test_Correa2015_MAH
  !!{RST
  Tests the :cite:t:`correa_accretion_2015` halo mass formation history algorithm.
  !!}
