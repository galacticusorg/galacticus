...
program Test_DiemerKravtsov2014_Concentration
  !!{RST
  Tests the :cite:t:`diemer_universal_2014` halo concentration algorithm. Values of concentration were taken from their website\footnote{File no longer available---was downloaded from ``http://www.benediktdiemer.com/wp-content/uploads/2014/07/Concentration_WMAP7_median.txt``}.
  !!}
