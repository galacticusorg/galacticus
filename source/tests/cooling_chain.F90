...
program Test_Cooling_Chain
  ...
  * the cooling radius, its growth rate, and the mass cooling rate: :math:`10^{-3}` relative. The cooling radius is located by a
  ...
  double precision                          , dimension(countCases)     :: timeDynamicalReference      =[2.5850857200d+00,2.5850857200d+00,9.1396582100d-01,2.5850857200d+00,4.9749997900d-01,2.5850857200d+00,9.1396582100d-01,2.5850857200d+00]
  ...
  double precision                          , dimension(countCases)     :: radiusCoolingGrowthReference=[0.0000000000d+00,0.0000000000d+00,3.0548334800d-02,2.4050639200d-02,3.5151840300d-02,2.5349416500d-02,5.1943230000d-02,0.0000000000d+00]
  double precision                          , dimension(countCases)     :: rateCoolingReference        =[1.2232776800d+09,3.8683436800d+09,5.6040190300d+09,3.0500292400d+09,8.8459161800d+09,2.3218778100d+09,3.2344651800d+09,0.0000000000d+00]
