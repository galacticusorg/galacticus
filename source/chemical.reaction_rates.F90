...
module Chemical_Reaction_Rates
  ...
  <functionClass>
   ...
   <method name="rates" >
    <description>Return the collisional excitation cooling rate , in units of J/m$^3$/s, for ion of given \source{atomicNumber} and \source{electronNumber} at temperature \source{T} (in Kelvin).</description>
    <type>void</type>
    <pass>yes</pass>
