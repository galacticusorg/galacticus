...
module Galactic_Structure_Solvers
  ...
  <functionClass>
   ...
   <method name="solve" >
    <description>Solves for the structure of components in the given \source{node}.</description>
    <type>void</type>
    <pass>yes</pass>
   ...
   <method name="revert" >
    <description>Revert the structure of components in the given \source{node} (if necessary to ensure that the structure solver will give the same result when called consecutively).</description>
    <type>void</type>
    <pass>yes</pass>
