...
module Merger_Tree_Data_Structure
  ...
  <enumeration>
   ...
   <description>Used to specify properties in a \source{mergerTreeData} structure.</description>
   <visibility>public</visibility>
   <validator>yes</validator>
   <encodeFunction>yes</encodeFunction>
  ...
  <enumeration>
   <name>units</name>
   <description>Used to specify the type of units being stored in a \source{mergerTreeData} structure.</description>
   <visibility>public</visibility>
   <validator>yes</validator>
   <entry label="mass"     />
   <entry label="length"   />
  ...
  <enumeration>
   ...
   <description>Used to specify the type of metadata being stored in a \source{mergerTreeData} structure.</description>
   <visibility>public</visibility>
   <validator>yes</validator>
   <encodeFunction>yes</encodeFunction>
   <decodeFunction>yes</decodeFunction>
  ...
  <enumeration>
   <name>dataType</name>
   <description>Used to specify the type of data being stored in a \source{mergerTreeData} structure metadata entry.</description>
   <visibility>public</visibility>
   <entry label="null"    />
   <entry label="integer" />
   <entry label="double"  />
