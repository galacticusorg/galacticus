...
!!}
  ...
  interface nbodyOperatorRotationCurve
     !!{RST
     Constructors for the ``nbodyOperatorRotationCurve`` N-body operator class.
     !!}
...
contains
  ...
  function rotationCurveConstructorParameters(parameters) result (self)
    !!{RST
    Constructor for the ``nbodyOperatorRotationCurve`` N-body operator class which takes a parameter set as input.
    !!}
  ...
  function rotationCurveConstructorInternal(selfBoundParticlesOnly,bootstrapSampleCount,radius,randomNumberGenerator_) result (self)
    !!{RST
    Internal constructor for the ``nbodyOperatorRotationCurve`` N-body operator class.
    !!}
    implicit none
    type            (nbodyOperatorRotationCurve)                              :: self
  ...
  subroutine rotationCurveDestructor(self)
    !!{RST
    Destructor for the ``nbodyOperatorRotationCurve`` N-body operator class.
    !!}
    implicit none
