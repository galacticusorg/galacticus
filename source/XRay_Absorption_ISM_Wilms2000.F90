...
program XRay_Absorption_ISM_Wilms2000
  ...
  \href{https://heasarc.gsfc.nasa.gov/xanadu/xspec/}{\normalfont \scshape XSpec} have been downloaded into the \mono{aux/XSpec} folder---usually this program will be run automatically as needed by the \mono{Galacticus::ISMColumnDensity} module.
  !!}
