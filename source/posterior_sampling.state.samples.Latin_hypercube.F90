...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface posteriorSamplesLatinHypercube
     !!{RST
     Constructors for the ``posteriorSamplesLatinHypercube`` posterior sampling state initialization class.
     !!}
...
contains
  ...
  function latinHypercubeConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the ``posteriorSamplesLatinHypercube`` posterior sampling state initialization class.
    !!}
  ...
  subroutine latinHypercubeDestructor(self)
    !!{RST
    Destructor for the ``posteriorSamplesLatinHypercube`` posterior sampling state initialization class.
    !!}
    implicit none
