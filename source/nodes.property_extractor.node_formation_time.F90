...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface nodePropertyExtractorNodeFormationTime
     !!{RST
     Constructors for the ``nodePropertyExtractorNodeFormationTime`` property extractor class.
     !!}
...
contains
  ...
  function nodeFormationTimeConstructorParameters(parameters) result(self)
    !!{RST
    Constructor for the ``nodePropertyExtractorNodeFormationTime`` property extractor class which takes a parameter set as input.
    !!}
  ...
  function nodeFormationTimeConstructorInternal() result(self)
    !!{RST
    Internal constructor for the ``nodePropertyExtractorNodeFormationTime`` property extractor class.
    !!}
    implicit none
    type(nodePropertyExtractorNodeFormationTime) :: self
