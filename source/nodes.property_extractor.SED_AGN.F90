...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <nodePropertyExtractor name="nodePropertyExtractorSEDAGN">
    <description>
      ...
      [wavelengthMinimum]} and \mono{[wavelengthMaximum]}. If \mono{[resolution]} is set to a
      ...
      \refClass{accretionDiskSpectraClass} object. The frame for the SED, \mono{rest} or {\normalfont \ttfamily
      observed}, is specified by \mono{[frame]}. Note that using \mono{observed} merely means
