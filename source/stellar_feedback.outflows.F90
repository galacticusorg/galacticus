...
module Stellar_Feedback_Outflows
  ...
  <functionClass>
   ...
   <method name="outflowRate" >
    <description>Returns the outflow rates (both ejective and expulsive) due to stellar feedback in the given \source{component} in units of $M_\odot/$Gyr.</description>
    <type>void</type>
    <pass>yes</pass>
