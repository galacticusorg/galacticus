...
!!{
Contains a module of utilities needed by the \source{percolation} virial density contrast class.
!!}

module Virial_Density_Contrast_Percolation_Utilities
  !!{
  Provides utilities needed by the \source{percolation} virial density contrast class.
  !!}
