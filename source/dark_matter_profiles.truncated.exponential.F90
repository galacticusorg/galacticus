...
contains
  ...
  function truncatedExponentialConstructorInternal(radiusFractionalDecay,unimplementedIsFatal,untruncatedProfile,darkMatterHaloScale_) result(self)
    ...
    !# <constructorAssign variables="radiusFractionalDecay,unimplementedIsFatal,*untruncatedProfile,*darkMatterHaloScale_"/>
