...
!
  ...
  type(fodeiv2_step_type), parameter, public :: &
       fodeiv2_step_rk2 = fodeiv2_step_type(1), &
       fodeiv2_step_rk4 = fodeiv2_step_type(2), &
       fodeiv2_step_rkf45 = fodeiv2_step_type(3), &
       fodeiv2_step_rkck = fodeiv2_step_type(4), &
       fodeiv2_step_rk8pd = fodeiv2_step_type(5), &
       fodeiv2_step_rk2imp = fodeiv2_step_type(6), &
       fodeiv2_step_rk4imp = fodeiv2_step_type(7), &
       fodeiv2_step_bsimp = fodeiv2_step_type(8), &
       fodeiv2_step_rk1imp = fodeiv2_step_type(9), &
       fodeiv2_step_msadams = fodeiv2_step_type(10), &
       fodeiv2_step_msbdf = fodeiv2_step_type(11)
  ...
  integer(fgsl_int), parameter, public :: fodeiv2_hadj_inc = 1
  integer(fgsl_int), parameter, public :: fodeiv2_hadj_nil = 0
  integer(fgsl_int), parameter, public :: fodeiv2_hadj_dec = -1
...
! odeiv2_control_alloc presently not attached
     ...
     function gsl_odeiv2_driver_alloc_standard_new(sys, t, hstart, eps_abs, eps_rel, a_y, a_dydt) bind(c)
       ...
       real(c_double), value :: hstart, eps_abs, eps_rel, a_y, a_dydt
     ...
     function gsl_odeiv2_driver_alloc_y_new(sys, t, hstart, eps_abs, eps_rel) bind(c)
       import
       type(c_ptr), value :: sys,t
       real(c_double), value :: hstart, eps_abs, eps_rel
...
!
  ...
  function fodeiv2_step_reset(s)
    ...
    integer(fgsl_int) :: fodeiv2_step_reset
...
!
  ...
  function fodeiv2_step_order(s)
    type(fodeiv2_step), intent(in) :: s
    integer(fgsl_int) :: fodeiv2_step_order
  ...
  function fodeiv2_step_apply(s, t, h, y, yerr, dydt_in, dydt_out, dydt)
    ...
    integer(fgsl_int) :: fodeiv2_step_apply
...
! FIXME (?) fodeiv2_control_alloc is presently not implemented
  function fodeiv2_control_init(c, eps_abs, eps_rel, a_y, a_dydt)
    ...
    real(fgsl_double), intent(in) :: eps_abs, eps_rel, a_y, a_dydt
    integer(fgsl_int) :: fodeiv2_control_init
  ...
  function fodeiv2_control_hadjust(c, s, y0, yerr, dydt, h) 
    ...
    integer(fgsl_int) :: fodeiv2_control_hadjust
...
!
  ...
  function fodeiv2_evolve_apply(e, con, step, dydt, t, t1, h, y) 
    ...
    integer(fgsl_int) :: fodeiv2_evolve_apply
!    write(6, *) 'Start evolving'
  ...
  function fodeiv2_evolve_reset(s)
    ...
    integer(c_int) :: fodeiv2_evolve_reset
  ...
  function fodeiv2_driver_alloc_standard_new(system, t, hstart, eps_abs, eps_rel, a_y, a_dydt)
    real(fgsl_double), intent(in) :: hstart, eps_abs, eps_rel, a_y, a_dydt
    type(fodeiv2_step_type), intent(in) :: t
  ...
  function fodeiv2_driver_alloc_y_new(system, t, hstart, eps_abs, eps_rel)
    real(fgsl_double), intent(in) :: hstart, eps_abs, eps_rel
    type(fodeiv2_step_type), intent(in) :: t
    type(fodeiv2_system), intent(in) :: system
  ...
  function fodeiv2_driver_set_hmin(d, hmin)
    real(fgsl_double), intent(in) :: hmin
    type(fodeiv2_driver), intent(inout) :: d
    integer(c_int) :: fodeiv2_driver_set_hmin
   ...
   function fodeiv2_driver_set_hmax(d, hmax)
    real(fgsl_double), intent(in) :: hmax
    type(fodeiv2_driver), intent(inout) :: d
    integer(c_int) :: fodeiv2_driver_set_hmax
   ...
   integer(c_long), intent(in) :: nmax
    type(fodeiv2_driver), intent(inout) :: d
    integer(c_int) :: fodeiv2_driver_set_nmax
