...
!!}
  ...
  interface nbodyOperatorFlagAlwaysIsolated
     !!{RST
     Constructors for the :galacticus-class:`nbodyOperatorFlagAlwaysIsolated` N-body operator class.
     !!}
...
contains
  ...
  function flagAlwaysIsolatedConstructorParameters(parameters) result (self)
    !!{RST
    Constructor for the :galacticus-class:`nbodyOperatorFlagAlwaysIsolated` N-body operator class which takes a parameter set as input.
    !!}
  ...
  function flagAlwaysIsolatedConstructorInternal(massFactor) result (self)
    !!{RST
    Internal constructor for the :galacticus-class:`nbodyOperatorFlagAlwaysIsolated` N-body operator class.
    !!}
    use :: Input_Parameters, only : inputParameters
    implicit none
    type            (nbodyOperatorFlagAlwaysIsolated)                :: self
