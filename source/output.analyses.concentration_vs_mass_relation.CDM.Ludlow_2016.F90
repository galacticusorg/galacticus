...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface outputAnalysisConcentrationVsHaloMassCDMLudlow2016
     !!{RST
     Constructors for the ``outputAnalysisConcentrationVsHaloMassCDMLudlow2016`` output analysis class.
     !!}
...
contains
  ...
  function concentrationVsHaloMassCDMLudlow2016ConstructorParameters(parameters) result (self)
    !!{RST
    Constructor for the ``outputAnalysisConcentrationVsHaloMassCDMLudlow2016`` output analysis class which takes a parameter set as input.
    !!}
  ...
  function concentrationVsHaloMassCDMLudlow2016ConstructorInternal(darkMatterProfileDMO_,cosmologyParameters_,cosmologyFunctions_,virialDensityContrast_,nbodyHaloMassError_,outputTimes_) result (self)
    !!{RST
    Constructor for the ``outputAnalysisConcentrationVsHaloMassCDMLudlow2016`` output analysis class for internal use.
    !!}
  ...
  subroutine concentrationVsHaloMassCDMLudlow2016Destructor(self)
    !!{RST
    Destructor for the ``outputAnalysisConcentrationVsHaloMassCDMLudlow2016`` output analysis class.
    !!}
    implicit none
