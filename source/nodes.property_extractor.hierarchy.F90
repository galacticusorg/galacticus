...
contains
  ...
  integer function hierarchyElementCount(self,time)
    !!{
    Return the number of elements in the \source{hierarchy} property extractors.
    !!}
    implicit none
  ...
  subroutine hierarchyNames(self,time,names)
    !!{
    Return the names of the \source{hierarchy} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorHierarchy), intent(inout)                             :: self
    double precision                                , intent(in   )                             :: time
  ...
  subroutine hierarchyDescriptions(self,time,descriptions)
    !!{
    Return the descriptions of the \source{hierarchy} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorHierarchy), intent(inout)                             :: self
    double precision                                , intent(in   )                             :: time
  ...
  function hierarchyUnitsInSI(self,time)
    !!{
    Return the units of the \source{hierarchy} properties in the SI system.
    !!}
