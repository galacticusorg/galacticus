...
contains
  ...
  subroutine massAccretionHistoryNames(self,names)
    !!{
    Return the names of the \source{massAccretionHistory} properties.
    !!}
    implicit none
    class(nodePropertyExtractorMassAccretionHistory), intent(inout)                             :: self
  ...
  subroutine massAccretionHistoryDescriptions(self,descriptions)
    !!{
    Return the descriptions of the \source{massAccretionHistory} properties.
    !!}
    implicit none
    class(nodePropertyExtractorMassAccretionHistory), intent(inout)                             :: self
  ...
  function massAccretionHistoryUnitsInSI(self) result(unitsInSI)
    !!{
    Return the units of the \source{massAccretionHistory} properties in the SI system.
    !!}
