...
!!}
  ...
  interface outputAnalysisWeightOperatorSubsampling
     !!{
     Constructors for the ``subsampling'' output analysis class.
     !!}
...
contains
  ...
  function subsamplingConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``subsampling'' output analysis weight operator class which takes a parameter set as input.
    !!}
