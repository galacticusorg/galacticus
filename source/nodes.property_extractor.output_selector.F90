...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface nodePropertyExtractorOutputSelector
     !!{
     Constructors for the {\normalfont \ttfamily outputSelector} output extractor class.
     !!}
...
contains
  ...
  function outputSelectorConstructorParameters(parameters) result(self)
    !!{
    Constructor for the {\normalfont \ttfamily outputSelector} output extractor property extractor class which takes a parameter set as input.
    !!}
