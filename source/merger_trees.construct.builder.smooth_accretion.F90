...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <mergerTreeBuilder name="mergerTreeBuilderSmoothAccretion">
   <description>
    ...
    \refPhysics{darkMatterHaloMassAccretionHistory} class. The tree has a final mass of \source{massHalo} (in
    units of $M_\odot$) at redshift \source{redshiftBase} and is continued back in time by decreasing the halo
    mass by a factor \source{massHaloDeclineFactor} at each new \gls{node} until a specified {\normalfont
