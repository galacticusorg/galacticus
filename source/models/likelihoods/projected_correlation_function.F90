...
contains
  ...
  function projectedCorrelationFunctionConstructorParameters(parameters) result(self)
    ...
    !!]
    self=posteriorSampleLikelihoodProjectedCorrelationFunction(haloMassMinimum,haloMassMaximum,lineOfSightDepth,halfIntegral,char(fileName),powerSpectrum_,cosmologyFunctions_,surveyGeometry_,darkMatterHaloScale_,haloMassFunction_,darkMatterProfileDMO_,darkMatterHaloBias_,darkMatterProfileScaleRadius_)
    !![
