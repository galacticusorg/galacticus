...
module Halo_Mass_Functions
  ...
  <functionClass docformat="rst">
   ...
   <method name="isCriticalOverdensityDependent" >
    <description>
    Return true if the differential halo mass function depends on the critical overdensity for collapse (:math:`\delta_\mathrm{c}`) object supplied to this class. This is used to detect mass functions that are compatible with models encoded through a mass-dependent critical overdensity (for example, the decaying dark matter model). Mass functions built on an :math:`f(\nu)` multiplicity that consume the critical overdensity return true, while pure :math:`f(\sigma)` fits, or those whose collapse barrier is provided through an excursion set object, return false. The default implementation returns false.
    </description>
    <type>logical</type>
    <pass>yes</pass>
    <code>
