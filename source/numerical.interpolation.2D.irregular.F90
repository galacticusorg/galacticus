...
!!{
Contains a module which implements a convenient interface to the \mono{BIVAR} 2D interpolation on irregularly spaced points
package.
!!}

module Numerical_Interpolation_2D_Irregular
  !!{
  Implements a convenient interface to the \mono{BIVAR} 2D interpolation on irregularly spaced points package.
  !!}
  implicit none
  private
