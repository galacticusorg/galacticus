...
contains
  ...
  !# </postEvolveTask>
  subroutine Hernquist_Spheroid_Post_Evolve(thisNode)
    !% Check for cases where the spheroid mass has become negative.
    use Galacticus_Display
    use String_Handling
    use ISO_Varying_String
    implicit none
    ...
    return
  end subroutine Hernquist_Spheroid_Post_Evolve
