...
contains
  ...
  subroutine interpolatorDestructorRank0(self)
    !!{
    Destructor for rank-0 \mono{interpolator} objects.
    !!}
    implicit none
  ...
  subroutine interpolatorDestructorRank1(self)
    !!{
    Destructor for rank-1 \mono{interpolator} objects.
    !!}
    implicit none
  ...
  subroutine interpolatorDestructorRank2(self)
    !!{
    Destructor for rank-2 \mono{interpolator} objects.
    !!}
    implicit none
    type   (interpolator), intent(inout), dimension(:,:) :: self
    integer                                              :: i1  , i2
  ...
  subroutine interpolator2DDestructorRank0(self)
    !!{
    Destructor for rank-0 \mono{interpolator2D} objects.
    !!}
    implicit none
