...
module Star_Formation_IMF_MillerScalo
  ...
  double precision, dimension(imfPieceCount) :: imfNormalization                                              , massExponent                    =[-1.25d0,-2.00d0,-2.30d0,-3.30d0], &
       &                                        massLower                          =[0.1d0,1.0d0,2.0d0,10.0d0], massUpper                       =[1.0d0,2.0d0,10.0d0,125.0d0]
...
contains
  ...
  !# </imfTabulate>
  subroutine Star_Formation_IMF_Tabulate_MillerScalo(imfSelected,imfMatched,imf)
    !% Register the name of this IMF.
    use Star_Formation_IMF_PPL
    use Tables
    implicit none
