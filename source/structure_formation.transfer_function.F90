...
module Transfer_Functions
  ...
  <functionClass>
   ...
   <method name="value" >
    <description>Return the transfer function for $k=$\source{wavenumber} [Mpc$^{-1}$].</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: wavenumber</argument>
   </method>
   <method name="logarithmicDerivative" >
    <description>Return the logarithmic derivative of the transfer function for $k=$\source{wavenumber} [Mpc$^{-1}$].</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>double precision, intent(in   ) :: wavenumber</argument>
   </method>
   ...
   <method name="fractionModeMass" >
    <description>Return the mass (in $M_\odot$) corresponding to the wavenumber at which the transfer function is suppressed is reduced by \source{fraction} due to small-scale dark matter particle physics.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <selfTarget>yes</selfTarget>
