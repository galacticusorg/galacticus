...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <enumeration>
   ...
   <description>Enumeration of sample types for the \source{klypin2015} dark matter profile shape parameter class.</description>
...
contains
  ...
  function klypin2015ConstructorParameters(parameters) result(self)
    !!{
    Default constructor for the \source{klypin2015} dark matter halo profile
    shape class.
    !!}
