...
contains
  ...
  function massProgenitorMaximumName(self)
    !!{
    Return the names of the \source{massProgenitorMaximum} properties.
    !!}
    implicit none
  ...
  function massProgenitorMaximumDescription(self)
    !!{
    Return the descriptions of the \source{massProgenitorMaximum} properties.
    !!}
    implicit none
  ...
  double precision function massProgenitorMaximumUnitsInSI(self)
    !!{
    Return the units of the \source{massProgenitorMaximum} properties in the SI system.
    !!}
