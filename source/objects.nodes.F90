...
module Galacticus_Nodes
  ...
  type, public :: mergerTree
   ...
   contains
     ...
     <methods>
       ...
       <method description="Create a \source{treeEvent} object in this tree." method="createEvent" />
       <method description="Remove a \source{treeEvent} from this tree." method="removeEvent" />
  ...
  type, public :: universe
   ...
   contains
     !![
     <methods>
       <method description="Create a \source{treeEvent} object in this universe." method="createEvent"/>
       <method description="Remove a \source{treeEvent} from this universe."      method="removeEvent"/>
       <method description="Pop a \source{mergerTree} from this universe."        method="popTree"    />
       <method description="Pop a \source{mergerTree} from this universe."        method="pushTree"   />
     </methods>
     !!]
  ...
  function Tree_Node_Constructor(index,hostTree) result(self)
    !!{
    Return a pointer to a newly created and initialized \source{treeNode}.
    !!}
  ...
  function Tree_Node_Type(self)
    !!{
    Returns the name of a \source{treeNode} object.
    !!}
  ...
  function Tree_Node_Index(self)
    !!{
    Returns the index of a \source{treeNode}.
    !!}
    implicit none
  ...
  subroutine Tree_Node_Index_Set(self,index)
    !!{
    Sets the index of a \source{treeNode}.
    !!}
    implicit none
  ...
  function Tree_Node_Unique_ID(self) result(uniqueID)
    !!{
    Returns the unique ID of a \source{treeNode}.
    !!}
    implicit none
    class  (treeNode      ), intent(in   ) :: self
  ...
  double precision function Tree_Node_Time_Step(self)
    !!{
    Returns the time-step last used by a \source{treeNode}.
    !!}
    implicit none
    class(treeNode), intent(in   ) :: self
  ...
  subroutine Tree_Node_Time_Step_Set(self,timeStep)
    !!{
    Sets the time-step used by a \source{treeNode}.
    !!}
    implicit none
    class           (treeNode      ), intent(inout) :: self
  ...
  double precision function Tree_Node_Subsampling_Weight(self)
    !!{
    Returns the subsampling weight of a \source{treeNode}.
    !!}
    implicit none
    class(treeNode), intent(in   ) :: self
  ...
  subroutine Tree_Node_Remove_Paired_Event(self,event)
    !!{
    Removed a paired event from \source{self}. Matching is done on the basis of event ID.
    !!}
    use :: Error, only : Error_Report
    implicit none
    class  (treeNode ), intent(inout) :: self
  ...
  logical function treeNodeIsPrimaryProgenitor(self) result(isPrimaryProgenitor)
    !!{
    Returns true if \source{self} is the primary progenitor of its parent node.
    !!}
    implicit none
  ...
  logical function Tree_Node_Is_Primary_Progenitor_Of_Index(self,targetNodeIndex)
    !!{
    Return true if \source{self} is a progenitor of the node with index \source{targetNodeIndex}.
    !!}
    implicit none
    class  (treeNode      ), intent(in   ), target :: self
  ...
  logical function Tree_Node_Is_Primary_Progenitor_Of_Node(self,targetNode)
    !!{
    Return true if \source{self} is a progenitor of \source{targetNode}.
    !!}
    implicit none
    class(treeNode), intent(in   ), target  :: self
  ...
  logical function Tree_Node_Is_On_Main_Branch(self)
    !!{
    Returns true if \source{self} is on the main branch.
    !!}
    implicit none
    class(treeNode), intent(inout), target :: self
    class(treeNode), pointer               :: workNode
  ...
  logical function Tree_Node_Is_Satellite(self)
    !!{
    Returns true if \source{self} is a satellite.
    !!}
    use :: Error, only : Error_Report
    implicit none
    class(treeNode), intent(in   ), target :: self
  ...
  function Tree_Node_Get_Isolated_Parent(self) result (isolatedNode)
    !!{
    Returns a pointer to the isolated parent node of \source{self}.
    !!}
    implicit none
    class(treeNode), intent(in   ), target  :: self
  ...
  function Tree_Node_Get_Last_Satellite(self) result (satelliteNode)
    !!{
    Returns a pointer to the final satellite node associated with \source{self}.
    !!}
    implicit none
    class(treeNode), intent(in   ) :: self
  ...
  function Tree_Node_Get_Earliest_Progenitor(self) result (progenitorNode)
    !!{
    Returns a pointer to the earliest progenitor of \source{self}.
    !!}
    use :: Error, only : Error_Report
    implicit none
  ...
  function Tree_Node_Merges_With_Node(node)
    !!{
    Returns a pointer to the node with which \source{node} will merge.
    !!}
    implicit none
  ...
  subroutine Tree_Node_Remove_From_Host(self)
    !!{
    Remove \source{self} from the linked list of its host node's satellites.
    !!}
  ...
  function treeNodeWalkBranchWithSatellites(self,startNode)
    ...
    tree. Given a pointer \source{self} to a branch of the tree, it will
    ...
    branch. Once the entire branch has been walked, a \source{null()} pointer
  ...
  function Merger_Tree_Walk_Descend_to_Progenitors(self) result (progenitorNode)
    !!{
    Descend to the deepest progenitor (satellites and children) of \source{self}.
    !!}
    implicit none
  ...
  subroutine Node_Component_Null_Void0_InOut(self)
    !!{
    A null \source{void} function for rank 0 \source{nodeComponent} arrays.
    !!}
    implicit none
    class(nodeComponent), intent(inout) :: self
    !$GLC attributes unused :: self
  ...
  double precision function Node_Component_Null_Double0_InOut(self)
    !!{
    A null \source{double} function for rank 0 \source{nodeComponent} arrays.
    !!}
    implicit none
    class(nodeComponent), intent(inout) :: self
    !$GLC attributes unused :: self
  ...
  function Node_Component_Null_Double1_InOut(self,resultSize)
    !!{
    A null \source{double} function for rank 1 \source{nodeComponent} arrays.
    !!}
    implicit none
    class           (nodeComponent), intent(inout)         :: self
  ...
  function Node_Component_Null_TensorR2D3_InOut(self)
    !!{
    A null \source{tensorRank2Dimension3Symmetric} function for \source{nodeComponent}s.
    !!}
    implicit none
  ...
  function Merger_Tree_Node_Get(tree,nodeIndex)
    !!{
    Return a pointer to a node in \source{tree} given the index of the node.
    !!}
    implicit none
  ...
  subroutine Merger_Tree_Remove_Event(self,event)
    !!{
    Removed an event from \source{self}.
    !!}
    implicit none
    class  (mergerTree), intent(inout) :: self
  ...
  subroutine universeRemoveEvent(self,event)
    !!{
    Remove an event from \source{self}.
    !!}
    implicit none
    class  (universe     ), intent(inout) :: self
  ...
  subroutine massDistributionCalculationReset(massDistributionsLast,node,uniqueID)
    !!{
    Reset the memoized \source{massDistribution} due to a \source{calculationReset} event.
    !!}
    implicit none
  ...
  subroutine massDistributionsDestroy()
    !!{
    Destroy memoized \source{massDistributions}.
    !!}
    implicit none    
    integer :: i
