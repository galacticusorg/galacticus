...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  interface powerSpectrumPrimordialTransferredFile
     !!{
     Constructors for the ``file'' transferred primordial power spectrum class.
     !!}
...
contains
  ...
  function fileConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``file'' transferred primordial power spectrum class which takes a
  ...
  function fileConstructorInternal(fileName,cosmologyParameters_,cosmologyFunctions_) result(self)
    !!{
    Internal constructor for the ``file'' transferred primordial power spectrum class.
    !!}
    implicit none
    type (powerSpectrumPrimordialTransferredFile)                        :: self
