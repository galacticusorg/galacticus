...
module Tree_Node_Methods_Dark_Matter_Profile_Scales
  ...
  public :: Tree_Node_Methods_Profile_Scale_Initialize, Tree_Node_Methods_Profile_Scale_Initialize_Rates,&
       ...
       &, Tree_Node_Methods_Profile_Scale_Plausibility
...
contains
  ...
  double precision function Tree_Node_Dark_Matter_Profile_Scale_Scale(thisNode,instance)
    ...
    Tree_Node_Dark_Matter_Profile_Scale_Scale=                                                      &
         & min(                                                                                     &
         &     scaleLengthMaximum                                                                 , &
         &     max(                                                                                 &
         &         scaleLengthMinimum                                                             , &
  ...
  !#  <unitName>Tree_Node_Methods_Profile_Scale_Plausibility</unitName>
  !# </radiusSolverPlausibility>
  subroutine Tree_Node_Methods_Profile_Scale_Plausibility(thisNode,galaxyIsPhysicallyPlausible)
    ...
    return
  end subroutine Tree_Node_Methods_Profile_Scale_Plausibility
