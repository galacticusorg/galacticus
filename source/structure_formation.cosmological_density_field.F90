...
module Cosmological_Density_Field
  ...
  <functionClass>
   ...
   <method name="timeOfCollapse" >
    <description>Returns the time of collapse for a perturbation of linear theory overdensity \source{criticalOverdensity}.</description>
    <type>double precision</type>
    <pass>yes</pass>
   ...
   <method name="isNodeDependent" >
    <description>Return true if the critical overdensity is dependent on the \source{node} object (not just the \source{node\%hostTree} object).</description>
    <type>logical</type>
    <pass>yes</pass>
   </method>
   <method name="isTreeDependent" >
    <description>Return true if the critical overdensity is dependent on the \source{node\%hostTree} object.</description>
    <type>logical</type>
    <pass>yes</pass>
   </method>
   <autoHook>
  ...
  <functionClass>
   ...
   <method name="overdensityLinear" >
    <description>Return the environmental linear overdensity for the given \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
   ...
   <method name="overdensityLinearGradientTime" >
    <description>Return the gradient with time of the environmental linear overdensity for the given \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type   (treeNode), intent(inout)           :: node</argument>
   </method>
   <method name="overdensityNonLinear" >
    <description>Return the environmental non-linear overdensity for the given \source{node}.</description>
    <type>double precision</type>
    <pass>yes</pass>
    <argument>type(treeNode), intent(inout) :: node</argument>
   </method>
  ...
  <functionClass>
   ...
   <method name="mass" >
    <description>Return the mass corresponding to the given \source{rootVariance} of the cosmological density field.</description>
    <type>double precision</type>
    <pass>yes</pass>
...
contains
  ...
  double precision function criticalOverdensityTimeOfCollapse(self,criticalOverdensity,mass,node,status)
    !!{
    Returns the time of collapse for a perturbation of linear theory overdensity \source{criticalOverdensity}.
    !!}
