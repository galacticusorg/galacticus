...
!!}
  ...
  interface metaTreeProcessingTimeTotalEvolveTime
     !!{
     Constructors for the ``totalEvolveTime'' merger tree processing time estimator.
     !!}
...
contains
  ...
  function totalEvolveTimeConstructorParameters(parameters) result(self)
    !!{
    Constructor for the ``totalEvolveTime'' merger tree processing time estimator class which takes a parameter set as input.
    !!}
  ...
  function totalEvolveTimeConstructorInternal(exponentTime,updateInterval) result(self)
    !!{
    Internal constructor for the ``totalEvolveTime'' merger tree processing time estimator class.
    !!}
    implicit none
    type            (metaTreeProcessingTimeTotalEvolveTime)                :: self
