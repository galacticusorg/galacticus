...
contains
  ...
  double precision function tinker2008GenericNormalization(self,time,mass)
    !!{
    Return the normalization for the \source{tinker2008Generic} halo mass function class.
    !!}
    implicit none
  ...
  double precision function tinker2008GenericA(self,time,mass)
    !!{
    Return the $a$ parameter for the \source{tinker2008Generic} halo mass function class.
    !!}
    implicit none
    class           (haloMassFunctionTinker2008Generic), intent(inout) :: self
    double precision                                   , intent(in   ) :: time, mass
  ...
  double precision function tinker2008GenericB(self,time,mass)
    !!{
    Return the $b$ parameter for the \source{tinker2008Generic} halo mass function class.
    !!}
    implicit none
    class           (haloMassFunctionTinker2008Generic), intent(inout) :: self
    double precision                                   , intent(in   ) :: time, mass
  ...
  double precision function tinker2008GenericC(self,time,mass)
    !!{
    Return the $c$ parameter for the \source{tinker2008Generic} halo mass function class.
    !!}
    implicit none
    class           (haloMassFunctionTinker2008Generic), intent(inout) :: self
    double precision                                   , intent(in   ) :: time, mass
