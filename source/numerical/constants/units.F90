...
module Numerical_Constants_Units
  ...
  !![
  <constant variable="metersToAngstroms" value="1.0d10" symbol="\text{Å}/\mathrm{m}" description="Number of Angstroms per meter." units="\AA/m" unitsInSI="1.0" reference="Defined." group="units"/>
  <constant variable="micronsToAngstroms" value="1.0d4" symbol="\text{Å}/\mu\mathrm{m}" description="Number of Angstroms per micron." units="\AA/$\mu$m" unitsInSI="1.0" reference="Defined." group="units"/>
