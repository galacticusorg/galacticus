...
program Tests_Power_Spectrum
  ...
  mass=(4.0d0*Pi/3.0d0)*thisCosmologyParameters%OmegaMatter()*thisCosmologyParameters%densityCritical()*(radiusNormalization/thisCosmologyParameters%HubbleConstant(unitsLittleH))**3
  ...
  sigma=sqrt(Power_Spectrum(2.0d0*Pi*thisCosmologyParameters%HubbleConstant(unitsLittleH)/radiusNormalization)*9.0d0/4.0d0/Pi/(radiusNormalization/thisCosmologyParameters%hubbleConstant(unitsLittleH))**3)
