...
contains
  ...
  subroutine jetPowerBlackHolesNames(self,names)
    !!{
    Return the names of the \source{jetPowerBlackHoles} properties.
    !!}
    implicit none
    class(nodePropertyExtractorJetPowerBlackHoles), intent(inout)                             :: self
  ...
  subroutine jetPowerBlackHolesDescriptions(self,descriptions)
    !!{
    Return the descriptions of the \source{jetPowerBlackHoles} properties.
    !!}
    implicit none
    class(nodePropertyExtractorJetPowerBlackHoles), intent(inout)                             :: self
  ...
  function jetPowerBlackHolesUnitsInSI(self) result(unitsInSI)
    !!{
    Return the units of the \source{jetPowerBlackHoles} properties in the SI system.
    !!}
