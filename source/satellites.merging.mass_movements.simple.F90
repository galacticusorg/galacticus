  ...
  <mergerMassMovements name="mergerMassMovementsSimple">
   <description>
    ...
    \begin{itemize}
     ...
     \ttfamily [minorMergerGasMovesTo]} parameter (either ``\source{disk}'' or ``{\normalfont \ttfamily
     spheroid}''), stars from the satellite moves to the spheroid of the central and mass in the central does not move.
    \end{itemize}
    Here, $f_\mathrm{major}=$\source{[majorMergerMassRatio]} is the mass ratio above which a merger is
