...
contains
  ...
  integer function densityProfileElementCount(self,time)
    !!{
    Return the number of elements in the \source{densityProfile} property extractors.
    !!}
    implicit none
  ...
  function densityProfileSize(self,time)
    !!{
    Return the number of array elements in the \source{densityProfile} property extractors.
    !!}
    implicit none
  ...
  function densityProfileExtract(self,node,time,instance)
    !!{
    Implement a \source{densityProfile} property extractor.
    !!}
  ...
  subroutine densityProfileNames(self,names,time)
    !!{
    Return the names of the \source{densityProfile} properties.
    !!}
    implicit none
    class           (nodePropertyExtractorDensityProfile), intent(inout)                             :: self
  ...
  subroutine densityProfileDescriptions(self,descriptions,time)
    !!{
    Return descriptions of the \source{densityProfile} property.
    !!}
    implicit none
    class           (nodePropertyExtractorDensityProfile), intent(inout)                             :: self
    double precision                                     , intent(in   ), optional                   :: time
  ...
  subroutine densityProfileColumnDescriptions(self,descriptions,values,valuesDescription,valuesUnitsInSI,time)
    !!{
    Return column descriptions of the \source{densityProfile} property.
    !!}
    implicit none
    class           (nodePropertyExtractorDensityProfile), intent(inout)                            :: self
    double precision                                     , intent(in   ), optional                  :: time
  ...
  function densityProfileUnitsInSI(self,time)
    !!{
    Return the units of the \source{densityProfile} properties in the SI system.
    !!}
