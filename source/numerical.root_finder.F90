...
module Root_Finder
  ...
  <enumeration>
   ...
   <description>Used to specify the way in which the bracketing range should be expanded when searching for roots using a \source{rootFinder} object.</description>
  ...
  <enumeration>
   ...
   <description>Used to specify the expected sign of the root function when searching for roots using a \source{rootFinder} object.</description>
  ...
  <enumeration>
   ...
   <description>Used to specify the stopping criterion to use when searching for roots using a \source{rootFinder} object.</description>
   <visibility>public</visibility>
   <entry label="delta"    />
  ...
  type :: rootFinder
   ...
   contains
     !![
     <methods>
       <method description="Set the function that evaluates $f(x)$ to use in a \source{rootFinder} object."                                          method="rootFunction"          />
       <method description="Set the functions that evaluate $f(x)$ and derivatives to use in a \source{rootFinder} object."                          method="rootFunctionDerivative"/>
       <method description="Set the type of algorithm to use in a \source{rootFinder} object."                                                       method="type"                  />
       <method description="Set the tolerance to use in a \source{rootFinder} object."                                                               method="tolerance"             />
       <method description="Specify how the initial range will be expanded in a \source{rootFinder} object to bracket the root."                     method="rangeExpand"           />
       ...
       <method description="Return the initialization state of a \source{rootFinder} object."                                                        method="isInitialized"         />
       <method description="Destroy the \source{rootFinder} object."                                                                                 method="destroy"               />
  ...
  interface
     ...
     function gsl_fsolver_type_get(i) bind(c,name='gsl_fsolver_type_get')
       !!{
       Template for GSL interface \source{fsolver} type function.
       !!}
       import c_ptr, c_int
     ...
     function gsl_fdfsolver_type_get(i) bind(c,name='gsl_fdfsolver_type_get')
       !!{
       Template for GSL interface \source{fdfsolver} type function.
       !!}
       import c_ptr, c_int
...
contains
  ...
  logical function rootFinderIsInitialized(self)
    !!{
    Return whether a \source{rootFinder} object is initialized.
    !!}
    implicit none
  ...
  recursive double precision function rootFinderFind(self,rootRange,rootRangeValues,report,status)
    !!{
    Finds the root of the supplied \source{root} function.
    !!}
  ...
  subroutine rootFinderRootFunction(self,rootFunction)
    !!{
    Sets the function to use in a \source{rootFinder} object.
    !!}
    implicit none
    class    (rootFinder          ), intent(inout) :: self
  ...
  subroutine rootFinderType(self,solverType)
    !!{
    Sets the type to use in a \source{rootFinder} object.
    !!}
    use :: Error, only : Error_Report
    implicit none
    class  (rootFinder), intent(inout) :: self
  ...
  subroutine rootFinderTolerance(self,toleranceAbsolute,toleranceRelative)
    !!{
    Sets the tolerances to use in a \source{rootFinder} object.
    !!}
    implicit none
    class           (rootFinder), intent(inout)           :: self
    double precision            , intent(in   ), optional :: toleranceAbsolute, toleranceRelative
  ...
  subroutine rootFinderRangeExpand(self,rangeExpandUpward,rangeExpandDownward,rangeExpandType,rangeUpwardLimit,rangeDownwardLimit,rangeExpandDownwardSignExpect,rangeExpandUpwardSignExpect,testLimits)
    !!{
    Sets the rules for range expansion to use in a \source{rootFinder} object.
    !!}
    implicit none
    class           (rootFinder                          ), intent(inout)           :: self
    type            (enumerationRangeExpandType          ), intent(in   ), optional :: rangeExpandType
  ...
  recursive function rootFunctionWrapper(x) bind(c)
    !!{
    Wrapper function callable by \source{GSL} used in root finding.
    !!}
    implicit none
