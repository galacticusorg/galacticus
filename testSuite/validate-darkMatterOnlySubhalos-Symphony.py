...
# Run models to validate a dark matter only subhalo evolution model against data from the Symphony and COZMIC suites.
...
# Extract and validate the likelihoods.
validate.extract("outputs/validate_darkMatterOnlySubhalos_COZMIC_WDM:3keV.hdf5","Dark Matter Only Subhalos (COZMIC WDM 3keV Milky Way)","darkMatterOnlySubhalosCOZMICWDM3keVMilkyWay","testSuite/parameters/validate_darkMatterOnlySubhalos_Symphony_CDM.xml")
