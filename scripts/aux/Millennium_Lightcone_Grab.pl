...
# dimensions 1/m^2/n by 1/m/n^2 radians. Given the inverse anglular size of the survey "invAngle"
...
die("Millennium_Lightcone_Grab.pl: lightcone angle is too large")
    if ( $m < 1 );
my $n = $m+1;
