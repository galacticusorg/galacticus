...
my @translations =
    (
	 ...
	 names         =>
	 {
	     ...
	     "starFormationSpheroidEfficiency"                                       => "starFormationTimescaleSpheroids.dynamicalTime.--efficiency"                         ,
	     "starFormationSpheroidVelocityExponent"                                 => "starFormationTimescaleSpheroids.dynamicalTime.--exponentVelocity"                   ,
	     "starFormationSpheroidMinimumTimescale"                                 => "starFormationTimescaleSpheroids.dynamicalTime.--timescaleMinimum"                   ,
	     "starFormationTimescaleSpheroidsVelocityMaximumScalingTimescale"        => "starFormationTimescaleSpheroids.velocityMaxScaling.--timescale"                     ,
	     "starFormationTimescaleSpheroidsVelocityMaximumScalingVelocityExponent" => "starFormationTimescaleSpheroids.velocityMaxScaling.--exponentVelocity"              ,
	     "starFormationTimescaleSpheroidsVelocityMaximumScalingRedshiftExponent" => "starFormationTimescaleSpheroids.velocityMaxScaling.--exponentRedshift"              ,
	     "starFormationDiskEfficiency"                                           => "starFormationTimescaleDisks.dynamicalTime.--efficiency"                             ,
	     "starFormationDiskVelocityExponent"                                     => "starFormationTimescaleDisks.dynamicalTime.--exponentVelocity"                       ,
	     "starFormationDiskMinimumTimescale"                                     => "starFormationTimescaleDisks.dynamicalTime.--timescaleMinimum"                       ,
	     "starFormationTimescaleDisksVelocityMaximumScalingTimescale"            => "starFormationTimescaleDisks.velocityMaxScaling.--timescale"                         ,
	     "starFormationTimescaleDisksVelocityMaximumScalingVelocityExponent"     => "starFormationTimescaleDisks.velocityMaxScaling.--exponentVelocity"                  ,
	     "starFormationTimescaleDisksVelocityMaximumScalingRedshiftExponent"     => "starFormationTimescaleDisks.velocityMaxScaling.--exponentRedshift"                  ,
	     "starFormationTimescaleDisksFixedTimescale"                             => "starFormationTimescaleDisks.fixed.--timescale"                                      ,
	     "starFormationTimescaleIntegratedSurfaceDensityTolerance"               => "starFormationTimescaleDisks.intgrtdSurfaceDensity.--tolerance"                      ,
	     "starFormationTimescaleDisksHaloScalingTimescale"                       => "starFormationTimescaleDisks.haloScaling.--timescale"                                ,
	     "starFormationTimescaleDisksHaloScalingVirialVelocityExponent"          => "starFormationTimescaleDisks.haloScaling.--exponentVelocityVirial"                   ,
	     "starFormationTimescaleDisksHaloScalingRedshiftExponent"                => "starFormationTimescaleDisks.haloScaling.--exponentRedshift"                         ,
