...
| [08 — Merger trees](08-merger-trees.ipynb) | Building Cole et al. (2000) merger trees, walking their nodes, and extracting per-node properties (masses, epochs, virial scalings); assembly histories across a tree suite. |
