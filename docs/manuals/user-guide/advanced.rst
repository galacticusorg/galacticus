...
A script, ``scripts/aux/validateParameters.py``, is provided to validate parameter files and thereby ensure that they are consistent with Galacticus's expectations and requirements. To use simply execute:

.. code-block:: none

    scripts/aux/validateParameters.py myParameters.xml
