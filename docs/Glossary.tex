...
\newglossaryentry{ddmg}{name={DDM},
    description={\href{https://en.wikipedia.org/wiki/Decaying_dark_matter}{Decaying dark matter} (DDM) is a hypothesized type of dark matter in which the particle decays, on some characteristic lifetime, into lighter daughter particles---which may include a massive daughter that receives a velocity kick, plus massless dark radiation}}
