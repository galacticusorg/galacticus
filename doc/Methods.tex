...
\begin{description}
 ...
 \item [{\tt friendsOfFriends}] The virial density constrast is computed to be consistent with that of halos found by a friends-of-friends algorithm in N-body simulations, given the linking length of that algorithm.
\end{description}
