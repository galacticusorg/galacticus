...
Galactic radii solver functions (see \refPhysics{methodsGalacticStructureSolver}) need to be able to interact with the components of a tree node to
\begin{enumerate}
