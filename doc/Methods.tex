...
\end{description}
Currently, the following pre-computed stellar spectra files are available as a separate download from \href{http://www.ctcp.caltech.edu/galacticus/data/Galacticus_SSP_Data.tar.bz2}{\tt http://www.ctcp.caltech.edu/galacticus/data/Galacticus\_SSP\_Data.tar.bz2}:
\begin{description}
