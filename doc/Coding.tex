...
Definitions of functions are accumulated either to the list {\normalfont \ttfamily \$build->\{'functions'\}} or are included as the {\normalfont \ttfamily descriptor} in a derived type structure (see \S\ref{sec:buildHierarchyTypes}). Each function structure has the form:
\begin{verbatim}
{
...
\section{Computation Dependencies and Data Files}\index{dependencies, computation}\index{labels, unique}\index{unique labels}
