...
Analysis and visualization of \glc\ outputs (including on-the-fly analysis plots, \gls{mcmc} chain diagnostics, and posterior corner plots) is provided by the companion \href{https://github.com/galacticusorg/dendros}{Dendros} package, which is available on \href{https://pypi.org/project/dendros/}{PyPI}.
