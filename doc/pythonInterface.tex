...
# Copy runtime dependencies (Linux; adjust filter as appropriate)
...
\end{verbatim}
On macOS, replace the \mono{ldd} step with an equivalent \mono{otool -L} invocation.
...
Alternatively, set \mono{LD\_LIBRARY\_PATH} to include the directory containing the missing library:
\begin{verbatim}
