...
Figure~\ref{fig:glcOutputFileStructure} shows the structure of a typical \glc\ output file. \glc\ can perform many different tasks, and output a wide variety of different data. The following describes the structure of an output file resulting from the ``{\normalfont \ttfamily evolveForests}'' \href{https://github.com/galacticusorg/galacticus/releases/download/masterRelease/Galacticus_Development.pdf\#methods.task}{\normalfont \ttfamily task} (i.e. the usal mode of running \glc\ where it is asked to form and evolve a population of galaxies within a set of merger trees) using the ``{\normalfont \ttfamily standard}'' \href{https://github.com/galacticusorg/galacticus/releases/download/masterRelease/Galacticus_Development.pdf\#methods.mergerTreeOutputter}{\normalfont \ttfamily mergerTreeOutputter}.
...
To perform such on-the-fly analysis, simply use the ``{\normalfont \ttfamily analyzer}'' \href{https://github.com/galacticusorg/galacticus/releases/download/masterRelease/Galacticus_Development.pdf\#methods.mergerTreeOutputter}{\normalfont \ttfamily mergerTreeOutputter}, by including the following in your parameter file:
\begin{verbatim}
 <mergerTreeOutputterMethod value="analyzer"/>
\end{verbatim}
If you want to also keep the standard output of all galaxy properties, simply combine the ``{\normalfont \ttfamily standard}'' and ``{\normalfont \ttfamily analyzer}'' \href{https://github.com/galacticusorg/galacticus/releases/download/masterRelease/Galacticus_Development.pdf\#methods.mergerTreeOutputter}{\normalfont \ttfamily mergerTreeOutputter}s:
\begin{verbatim}
...
The analysis to be performed is determined by the \href{https://github.com/galacticusorg/galacticus/releases/download/masterRelease/Galacticus_Development.pdf\#methods.outputAnalysis}{\normalfont \ttfamily outputAnalysis} class. For example, to compute the GAMA stellar mass function \citep{baldry_galaxy_2012} you would include in your parameter file:
\begin{verbatim}
 <outputAnalysisMethod value="massFunctionStellarBaldry2012GAMA"/>
\end{verbatim}
...
Multiple on-the-fly analyses can be performed, by simply grouping them inside a ``{\normalfont \ttfamily multi}'' \href{https://github.com/galacticusorg/galacticus/releases/download/masterRelease/Galacticus_Development.pdf\#methods.outputAnalysis}{\normalfont \ttfamily outputAnalysis} class, e.g.:
\begin{verbatim}
 <outputAnalysisMethod value="multi">
  <outputAnalysisMethod value="massFunctionStellarBaldry2012GAMA"/>
  <outputAnalysisMethod value="massFunctionHIALFALFAMartin2010"  />
