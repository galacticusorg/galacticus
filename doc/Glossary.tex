...
\newacronym{cie}{CIE}{collisional ionization equilibrium}
...
\newglossaryentry{class}{name={CLASS}, description={\href{http://class-code.net}{CLASS} is a code to compute anisotropies in the cosmic microwave background, and the linear theory power spectra of matter and radiation}}
...
\newglossaryentry{gnu}{name={GNU}, description={\href{https://en.wikipedia.org/wiki/GNU}{GNU} is a free software collection used extensively on Unix-like operating systems}}
