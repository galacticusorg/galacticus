...
\newglossaryentry{hod}{type=\acronymtype, name={HOD}, description=\glslink{hodg}{semi-analytic model}, first={halo occupation distribution (HOD)}, see=[Glossary:]{hodg}, firstplural={halo occupation distributions (HODs)}, see=[Glossary:]{hodg}}
...
\newglossaryentry{bieg}{name={BIE},
    description={The \ref{http://www.astro.umass.edu/BIE/}{Bayesian Inference Engine} (BIE) is a software package designed to facilitate exploration of complexes parameter spaces using Bayesian techniques.}}
