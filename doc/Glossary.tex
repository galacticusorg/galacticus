...
\newglossaryentry{ann}{name={Approximate Nearest Neighbor}, description={The \href{http://www.cs.umd.edu/~mount/ANN/}{\sc Approximate Nearest Neighbor} library is a software package used finding the closest set of points to a given point, approximately}}
