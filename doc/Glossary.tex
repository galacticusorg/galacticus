...
\newglossaryentry{recfast}{name={RecFast}, description={\href{http://www.astro.ubc.ca/people/scott/recfast.html}{RecFast} is a code to calculate the recombination history of the universe}}
