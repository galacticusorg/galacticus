...
% Monospace/source code formatting.
\newcommand{\source}[1]{{\normalfont \ttfamily #1}}
...
\newcommand{\refClass}[1]{\ifthenelse{\equal{\docname}{Development}}{\source{#1} (see \S\ref{class:#1})}{\href{https://github.com/galacticusorg/galacticus/releases/download/bleeding-edge/Galacticus_Development.pdf\#class.#1}{\source{#1}}}}
%% Link to a physics description by class name.
\newcommand{\refPhysics}[1]{\ifthenelse{\equal{\docname}{Physics}}{\source{#1} (see \S\ref{phys:#1})}{\href{https://github.com/galacticusorg/galacticus/releases/download/bleeding-edge/Galacticus_Physics.pdf\#physics.#1}{\source{#1}}}}
