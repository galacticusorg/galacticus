...
It is likely that the default compiler is older than GCC v4.8 that is required to properly compile the code without any errors. Use a package manager to download as recent a version as possible of {\tt gcc}. For the case of MacPorts, this requires,
