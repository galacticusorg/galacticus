...
mkdir gcc-build
cd gcc-build
../gcc-4.7.0/configure --prefix=/your/install/path/gcc-trunk --enable-languages=c,c++,fortran --disable-multilib
make
make install
...
wget "http://www.ctcp.caltech.edu/galacticus/galacticus_v0.9.1.tar.bz2"
tar xvfj galacticus_v0.9.1.tar.bz2
cd Galacticus/v0.9.1

! Add to Makefile (below the FCFLAGS = line):

FCFLAGS += -fintrinsic-modules-path /your/install/path/finclude -fintrinsic-modules-path /your/install/path/include/gfortran -fintrinsic-modules-path /your/install/path -fintrinsic-modules-path /your/install/path/include -L /your/install/path/lib
\end{lstlisting}
