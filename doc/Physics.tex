...
\end{equation}
where $\rho(r)$ is the density profile of the hot halo, and $r_{\rm infall}$ is the smaller of the cooling and freefall radii in the hot halo if {\tt [coolingRateLimitByFreefall]}$=${\tt true} or simply equals the cooling radius otherwise. The cooling rate is also set to zero in halos with virial velocities below {\tt [coolingCutOffVelocity]} at redshifts below {\tt [coolingCutOffRedshift]}.
...
\subsection{Cooling: Freefall Radius}\index{freefall radius}\index{cooling!freefall radius}
