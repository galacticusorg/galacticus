...
\begin{description}
 \item [{\normalfont \ttfamily majorMergerTime}] The time(s) of galaxy major mergers experience by this node. Major merger times are output to a avriable-length dataset {\normalfont \ttfamily mergingStatisticsMajorMergerTimes} in the \href{https://github.com/galacticusorg/galacticus/releases/download/bleeding-edge/Galacticus_Usage.pdf\#sec.nodeDataGroup}{\normalfont \ttfamily nodeData} group.
\end{description}
