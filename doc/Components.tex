...
\begin{description}
 ...
 \item [{\normalfont \ttfamily chemicals}] The mass(es) of molecules in the hot gas, $M_\mathrm{chemical}$ {\normalfont \ttfamily [hotHaloChemicals\{chemicalName\}]}.
 \item [{\normalfont \ttfamily outerRadius}] The outer boundary radius of the hot halo: $r_\mathrm{hot, outer}$ {\normalfont \ttfamily [hotHaloOuterRadius]}.
...
\begin{description}
 ...
 \item [{\normalfont \ttfamily radius}] The half-mass radius of the spheroid: $r_\mathrm{spheroid, 1/2}$ [{\normalfont \ttfamily spheroidRadius}].
\end{description}
...
\begin{description}
 \item [{\normalfont \ttfamily masGas}] The mass of gas in the spheroid: $M_\mathrm{spheroid, gas}$ [{\normalfont \ttfamily spheroidMassGas}].
...
\begin{description}
 ...
 \item [{\normalfont \ttfamily radiusTurnaround}] The turnaround radius corresponding to the current ``Bertschinger''mass: $R_\mathrm{ta}$ [{\normalfont \ttfamily basicRadiusTurnaround}]
\end{description}
...
\begin{description}
 ...
 \item[{\normalfont \ttfamily tidalHeatingNormalized}] The tidal heating energy per radius squared deposited into the satellite: $Q_\mathrm{tidal}$.
\end{description}
