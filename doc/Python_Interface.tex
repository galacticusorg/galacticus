...
\begin{itemize}
  \item Python~3 (any recent version), together with the Python packages listed in the standard \glc\ build requirements (used by the build-time preprocessing and code-generation scripts such as \mono{scripts/build/preprocess.py} and \mono{scripts/build/buildCode.py}).
\end{itemize}
