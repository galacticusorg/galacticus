...
\begin{itemize}
  ...
  \item the Perl modules listed in the standard \glc\ build requirements (needed by the preprocessing scripts such as \mono{scripts/build/preprocess.pl} that are invoked during the build).
\end{itemize}
