...
die("stellarHaloMassRelation_Leauthaud2012_Z2.pl <galacticusFile> [options]")
...
# Evaluate the model.
&Galacticus::Constraints::StellarHaloMassRelation::COSMOS2012($galacticusFileName,2,%options);
