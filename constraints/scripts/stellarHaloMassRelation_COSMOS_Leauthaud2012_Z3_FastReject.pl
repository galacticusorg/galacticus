...
die("stellarHaloMassRelation_Leauthaud2012_Z3_FastReject.pl <galacticusFile> [options]")
...
# Evaluate the model.
&Galacticus::Constraints::StellarHaloMassRelation::COSMOS2012_FastReject($galacticusFileName,3,%options);
