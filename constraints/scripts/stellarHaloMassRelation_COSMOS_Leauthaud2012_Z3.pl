...
die("stellarHaloMassRelation_Leauthaud2012_Z3.pl <galacticusFile> [options]")
...
# Evaluate the model.
&Galacticus::Constraints::StellarHaloMassRelation::COSMOS2012($galacticusFileName,3,%options);
