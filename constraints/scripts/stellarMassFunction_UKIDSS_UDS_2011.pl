...
die("stellarMassFunction_UKIDSS_UDS_2011.pl <galacticusFile> <outputFile> <plotFile>") unless ( $#ARGV == 1 || $#ARGV == 2 );
my $self           = $0;
...
my $data      = $xml->XMLin($galacticusPath."data/observations/massFunctionsStellar/Stellar_Mass_Functions_UKIDSS_UDS_2011.xml");
