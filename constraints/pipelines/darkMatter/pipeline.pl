    ...
    (
	 ...
	 base         =>
	     [
	      ...
	      # Excluded due to contamination by low-res particles.
	      # "haloMassFunctionBase_LMC_Halo479_z0.000.xml"             ,
	      # "haloMassFunctionBase_LMC_Halo479_z0.504.xml"             ,
	      # "haloMassFunctionBase_LMC_Halo479_z0.990.xml"             ,
	      # "haloMassFunctionBase_LMC_Halo479_z2.031.xml"             ,
	      # "haloMassFunctionBase_LMC_Halo479_z3.984.xml"             ,
	      ...
	      "haloMassFunctionBase_LMC_Halo888_z0.504.xml"             ,
	      "haloMassFunctionBase_LMC_Halo888_z0.990.xml"             ,
	      "haloMassFunctionBase_LMC_Halo888_z2.031.xml"             ,
	      "haloMassFunctionBase_LMC_Halo888_z3.984.xml"             ,
